...
package com.kuma.cloud.rpc.registry.apiregistry.registry;

import com.kuma.cloud.rpc.registry.apiregistry.base.ApiRegistryException;
...
public class RedisRegistry extends BaseRegistry {
    Jedis jedis;
    // key前缀
    private final String KEY_PREFIX = "env" + "@" + "com.kuma.cloud.rpc.registry.apiregistry";
    // 当前实例标识
