...
import com.kuma.cloud.rpc.registry.apiregistry.base.*;
...
public class Aspects {
    ...
    public static class ApiClientAspect {
        ...
        @Pointcut("@within(com.kuma.cloud.rpc.registry.apiregistry.anno.ApiClient)")
    ...
    public static class AllClientAspect {
        ...
        @Pointcut(
                "@within(com.kuma.cloud.rpc.registry.apiregistry.anno.ApiClient) || @within(org.springframework.cloud.openfeign.FeignClient)")
        public void pointCut() {
        }
