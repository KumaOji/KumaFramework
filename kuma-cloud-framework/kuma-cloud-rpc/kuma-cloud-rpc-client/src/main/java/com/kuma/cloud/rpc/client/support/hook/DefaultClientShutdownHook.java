...
package com.kuma.cloud.rpc.client.support.hook;

import com.kuma.cloud.rpc.client.support.register.ClientRegisterManager;
import com.kuma.cloud.rpc.common.common.support.hook.AbstractShutdownHook;
...
import com.kuma.cloud.rpc.common.common.util.Waits;
...
public class DefaultClientShutdownHook extends AbstractShutdownHook {
    ...
    public DefaultClientShutdownHook clientRegisterManager(
