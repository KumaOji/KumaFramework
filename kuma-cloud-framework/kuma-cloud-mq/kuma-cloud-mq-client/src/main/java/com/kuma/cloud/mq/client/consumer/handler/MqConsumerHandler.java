...
package com.kuma.cloud.mq.client.consumer.handler;
...
public class MqConsumerHandler extends SimpleChannelInboundHandler {
    ...
    private MqCommonResp consumer(final String json) {
        try {
            ...
            MqConsumerListenerContext context = new com.kuma.cloud.mq.client.consumer.support.listener.MqConsumerListenerContext();
