...
import com.kuma.cloud.mq.common.rpc.RpcAddress;
...
public class ChannelFutureUtils {
     ...
     * @since 2024.05
     */
    public static List<RpcChannelFuture> initChannelFutureList(
            final String brokerAddress, final ChannelHandler channelHandler, final boolean check) {
