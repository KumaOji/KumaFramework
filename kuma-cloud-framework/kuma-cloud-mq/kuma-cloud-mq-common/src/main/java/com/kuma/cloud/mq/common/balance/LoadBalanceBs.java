...
package com.kuma.cloud.mq.common.balance;
...
public final class LoadBalanceBs<T extends Server> {
    ...
    public T select() {
        ...
        LoadBalanceContext<T> context =
                com.kuma.cloud.mq.common.balance.impl.LoadBalanceContext.<T>newInstance().hashKey(this.hashKey).servers(this.servers);
