...
package com.kuma.cloud.tx.rm.interceptor;
...
public class RequestInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(
        ...
        if (null != groupId || !"".equals(groupId)) {
            KmcTxParticipant.setCurrentGroupId(groupId);
            KmcTxParticipant.setTransactionCount(
    ...
    public void postHandle(
        ...
        //        if (KmcTxParticipant.getCurrentGroupId() == null){
        //            if (null != groupId){
    ...
    public void afterCompletion(
        ...
        //        System.err.println("后置拦截器：" + KmcTxParticipant.getCurrentGroupId());
    }
}
