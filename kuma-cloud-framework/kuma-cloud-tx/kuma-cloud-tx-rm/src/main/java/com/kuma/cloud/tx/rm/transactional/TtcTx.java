...
import com.kuma.cloud.tx.rm.util.Task;
...
public class KmcTx {
    ...
    public KmcTx( String groupId, String transactionalId, TransactionalType transactionalType ) {
    ...
    public KmcTx( String groupId, String transactionalId ) {
        this.groupId = groupId;
        this.transactionalId = transactionalId;
        this.task = new Task();
    }
