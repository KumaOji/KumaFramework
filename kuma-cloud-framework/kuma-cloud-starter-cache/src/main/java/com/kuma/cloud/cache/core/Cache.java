...
package com.kuma.cloud.cache.core;

import com.kuma.boot.common.utils.lang.ObjectUtils;
import com.kuma.cloud.cache.annotation.CacheInterceptor;
import com.kuma.cloud.cache.api.*;
import com.kuma.cloud.cache.constant.enums.CacheRemoveType;
import com.kuma.cloud.cache.exception.CacheRuntimeException;
import com.kuma.cloud.cache.support.evict.CacheEvictContext;
import com.kuma.cloud.cache.support.persist.InnerCachePersist;
import com.kuma.cloud.cache.support.proxy.DefaultCacheProxy;
import java.util.*;
 ...
 * @since 2024.06
 */
public class Cache<K, V> implements com.kuma.cloud.cache.api.Cache<K, V> {
     ...
     */
    public void init() {
        this.expire = new com.kuma.cloud.cache.support.expire.CacheExpire<>(this);
        this.load.load(this);
    ...
    @Override
    @CacheInterceptor
    public com.kuma.cloud.cache.api.Cache<K, V> expire(K key, long timeInMills) {
    ...
    public com.kuma.cloud.cache.api.Cache<K, V> expireAt(K key, long timeInMills) {
    ...
    public V put(K key, V value) {
        ...
        if (ObjectUtils.isNotNull(evictEntry)) {
            ...
            CacheRemoveListenerContext<K, V> removeListenerContext =
                    com.kuma.cloud.cache.support.listener.remove.CacheRemoveListenerContext.<K, V>newInstance()
                            .key(evictEntry.key())
