...
package com.kuma.cloud.cache.bs;
...
import com.kuma.cloud.cache.support.listener.remove.CacheRemoveListeners;
import com.kuma.cloud.cache.support.listener.slow.CacheSlowListeners;
import com.kuma.cloud.cache.support.load.CacheLoads;
...
public final class CacheBs<K, V> {
    ...
    public Cache<K, V> build() {
        com.kuma.cloud.cache.core.Cache<K, V> cache = new com.kuma.cloud.cache.core.Cache<>();
        cache.map(map);
        cache.evict(evict);
