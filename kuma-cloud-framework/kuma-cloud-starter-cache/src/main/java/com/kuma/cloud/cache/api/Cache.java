...
package com.kuma.cloud.cache.api;
...
public interface Cache<K, V> extends Map<K, V> {
     ...
     * @since 22024.06
     */
    Cache<K, V> expire(final K key, final long timeInMills);
     ...
     * @since 22024.06
     */
    Cache<K, V> expireAt(final K key, final long timeInMills);
     ...
     * @since 22024.06
     */
    List<CacheRemoveListener<K, V>> removeListeners();
     ...
     * @since 22024.06
     */
    List<CacheSlowListener> slowListeners();
