...
package com.kuma.cloud.cache.support.proxy.bs;

import com.kuma.cloud.cache.api.Cache;
import com.kuma.cloud.cache.api.CacheInterceptor;
import com.kuma.cloud.cache.api.CachePersist;
import com.kuma.cloud.cache.support.interceptor.CacheInterceptorContext;
import com.kuma.cloud.cache.support.interceptor.CacheInterceptors;
import com.kuma.cloud.cache.support.persist.CachePersistAof;
...
public final class CacheProxyBs {
    ...
    public Object execute() throws Throwable {
        ...
        // 1. 获取刷新注解信息
        com.kuma.cloud.cache.annotation.CacheInterceptor cacheInterceptor = context.interceptor();
    ...
    private void interceptorHandler(
            com.kuma.cloud.cache.annotation.CacheInterceptor cacheInterceptor,
            CacheInterceptorContext interceptorContext,
            Cache cache,
            boolean before) {
