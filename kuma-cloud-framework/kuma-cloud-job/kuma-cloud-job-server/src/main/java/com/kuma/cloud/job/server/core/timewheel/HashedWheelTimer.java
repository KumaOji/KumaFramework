...
package com.kuma.cloud.job.server.core.timewheel;

import com.google.common.collect.Queues;
import com.google.common.collect.Sets;
import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.kuma.cloud.job.common.utils.CommonUtils;
import com.kuma.cloud.job.server.extension.threadpool.RejectedExecutionHandlerFactory;
...
public class HashedWheelTimer implements Timer {
        ...
        if (processThreadNum <= 0) {
            ...
            taskProcessPool =
                    new ThreadPoolExecutor(
                            ...
                            queue,
                            threadFactory,
                            RejectedExecutionHandlerFactory.newCallerRun("KmcJobTimeWheelPool"));
        }
    ...
    public TimerFuture schedule( TimerTask task, long delay, TimeUnit unit ) {
        ...
        // 写入阻塞队列，保证并发安全（性能进一步优化可以考虑 Netty 的 Multi-Producer-Single-Consumer队列）todo 后续学习
            ...
            removeIf(
                    timerFuture -> {
                        ...
                        if (timerFuture.totalTicks <= currentTick) {
                            ...
                            if (timerFuture.totalTicks < currentTick) {
                                log.warn(
                                        "[HashedWheelTimer] timerFuture.totalTicks < currentTick, please fix the bug");
                            }
