...
package com.kuma.cloud.job.server.consumer;

import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.google.protobuf.InvalidProtocolBufferException;
import com.kuma.cloud.job.remote.protos.MqCausa;
import com.kuma.cloud.job.server.consumer.entity.FlushRequest;
import com.kuma.cloud.job.server.consumer.entity.Response;
...
public class DefaultMessageStore {
    ...
    public void startWatcher( Consumer consumer ) {
        ...
        ThreadFactory consumerThreadPoolFactory =
                new ThreadFactoryBuilder().setNameFormat("kmcjob-consumer-%d").build();
    ...
    class SyncFlushService implements Runnable {
        ...
        public SyncFlushService() {
            ...
            ThreadFactory callbackThreadPoolFactory =
                    new ThreadFactoryBuilder().setNameFormat("kmcjob-callback-%d").build();
