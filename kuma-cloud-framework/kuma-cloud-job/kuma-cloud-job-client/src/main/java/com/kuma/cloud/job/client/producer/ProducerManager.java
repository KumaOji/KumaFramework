...
import com.kuma.cloud.remote.api.MqGrpc;
...
public class ProducerManager {
    ...
    public ProducerManager( List<String> nameServerAddressList ) {
        ...
        ThreadFactory producerExecuteFactory =
                new ThreadFactoryBuilder().setNameFormat("kmcjob-producer-send-%d").build();
        threadPoolExecutor =
        ...
        ThreadFactory invokeCallbackExecuteFactory =
                new ThreadFactoryBuilder().setNameFormat("kmcjob-invokeCallback-%d").build();
