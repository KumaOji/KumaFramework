...
package com.kuma.cloud.job.client.producer;

import com.kuma.cloud.job.client.producer.entity.JobDeleteReq;
import com.kuma.cloud.job.client.producer.entity.JobUpdateReq;
import com.kuma.cloud.job.client.producer.uid.IdGenerateService;
...
import com.kuma.cloud.job.remote.protos.MqCausa;
...
public class KmcJobTemplate {
     ...
     */
    public KmcJobTemplate( String nameServerAddress ) {
    ...
    public static void main( String[] args ) {
        KmcJobTemplate kmcJobTemplate = new KmcJobTemplate("127.0.0.1:9083");
        JobUpdateReq build =
                JobUpdateReq.builder()
                        ...
                        .build();
        kmcJobTemplate.createJob(build);
    }
}
