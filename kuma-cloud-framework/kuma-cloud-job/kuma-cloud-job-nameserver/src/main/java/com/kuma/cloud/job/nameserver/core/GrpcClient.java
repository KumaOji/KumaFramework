...
package com.kuma.cloud.job.nameserver.core;
...
import com.kuma.cloud.job.nameserver.module.sync.*;
...
import com.kuma.cloud.remote.api.DistroGrpc;
...
public class GrpcClient {
    ...
    public GrpcClient( KmcJobNameServerConfig kmcJobNameServerConfig ) {
        for (String ip : kmcJobNameServerConfig.getServerAddressList()) {
