...
package com.kuma.cloud.job.nameserver.core.distro;

import com.kuma.cloud.job.common.constant.RemoteConstant;
import com.kuma.cloud.job.common.utils.net.MyNetUtil;
import com.kuma.cloud.job.nameserver.config.KmcJobNameServerConfig;
import com.kuma.cloud.job.nameserver.core.GrpcClient;
import com.kuma.cloud.job.nameserver.module.sync.SyncInfo;
import com.kuma.cloud.job.remote.protos.DistroCausa;
...
public class DistroClientDataProcessor {
    ...
    public DistroClientDataProcessor(
            KmcJobNameServerConfig kmcJobNameServerConfig, GrpcClient grpcClient) {
        this.curServerIp = MyNetUtil.address;
        this.clusterNodes = kmcJobNameServerConfig.getServerAddressList();
