 ...
 */
@ConfigurationProperties(prefix = "kmcjob")
public class KmcJobProperties {
    ...
    @Deprecated
    @DeprecatedConfigurationProperty(replacement = "kmcjob.worker.app-name")
    ...
    @DeprecatedConfigurationProperty(replacement = "kmcjob.worker.grpc-port")
    ...
    @Deprecated
    @DeprecatedConfigurationProperty(replacement = "kmcjob.worker.server-address")
    ...
    @Deprecated
    @DeprecatedConfigurationProperty(replacement = "kmcjob.worker.name-server-address")
    ...
    @Deprecated
    @DeprecatedConfigurationProperty(replacement = "kmcjob.worker.server-port")
