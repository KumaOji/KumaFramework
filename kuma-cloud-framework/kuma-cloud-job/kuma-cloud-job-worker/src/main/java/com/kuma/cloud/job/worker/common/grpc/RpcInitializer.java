...
package com.kuma.cloud.job.worker.common.grpc;
...
import com.kuma.cloud.job.worker.common.grpc.strategies.StrategyManager;
import com.kuma.cloud.job.worker.service.WorkerScheduleGrpcService;
...
public class RpcInitializer {
    ...
    public void initRpcStrategies() {
        ...
        Reflections reflections =
                new Reflections("com.kuma.cloud.job.worker.common.grpc.strategies.strategy");
    ...
    public void initRpcServer( KmcJobWorkerConfig config ) {
        new Thread(
                () -> {
                    try {
