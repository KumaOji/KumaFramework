...
package com.kuma.cloud.job.worker.service.handler;
...
import com.kuma.cloud.job.worker.core.schedule.tracker.task.light.LightTaskTracker;
...
public class ScheduleJobHandler implements RpcHandler {
    ...
    public ScheduleJobHandler( KmcJobWorkerConfig kmcJobWorkerConfig ) {
        config = kmcJobWorkerConfig;
    }
