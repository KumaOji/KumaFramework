...
package com.kuma.cloud.job.worker.core.schedule.tracker.task;

import com.kuma.cloud.job.remote.protos.ScheduleCausa;
import com.kuma.cloud.job.worker.common.KmcJobWorkerConfig;
import com.kuma.cloud.job.worker.common.module.InstanceInfo;
...
public abstract class TaskTracker {
     ...
     * worker 运行时元数据
     */
    protected final KmcJobWorkerConfig config;
    ...
    protected TaskTracker(ScheduleCausa.ServerScheduleJobReq req, KmcJobWorkerConfig config) {
