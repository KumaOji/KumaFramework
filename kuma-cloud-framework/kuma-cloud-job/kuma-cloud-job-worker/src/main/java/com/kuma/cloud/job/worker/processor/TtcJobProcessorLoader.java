...
package com.kuma.cloud.job.worker.processor;
 ...
 */
@Slf4j
public class KmcJobProcessorLoader implements ProcessorLoader {
    ...
    public KmcJobProcessorLoader(List<ProcessorFactory> processorFactoryList) {
