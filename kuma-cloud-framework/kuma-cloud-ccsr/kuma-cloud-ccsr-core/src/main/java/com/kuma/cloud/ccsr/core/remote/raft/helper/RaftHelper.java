...
package com.kuma.cloud.ccsr.core.remote.raft.helper;
...
import com.kuma.cloud.ccsr.core.executor.NameThreadFactory;
import com.kuma.cloud.ccsr.core.remote.raft.RaftServer;
import com.kuma.cloud.ccsr.core.remote.raft.processor.DeleteRequestRpcProcessor;
import com.kuma.cloud.ccsr.core.remote.raft.processor.ReadRequestRpcProcessor;
import com.kuma.cloud.ccsr.core.remote.raft.processor.WriteRequestRpcProcessor;
import com.kuma.cloud.ccsr.core.serializer.SerializeFactory;
import java.io.File;
...
public class RaftHelper {
    ...
    public static ExecutorService getDefaultExecutor() {
        ...
        return Executors.newFixedThreadPool(
                8, new NameThreadFactory("com.kuma.cloud.ccsr.remote.raft-default"));
    }

    public static ExecutorService getCliExecutor() {
        // 创建一个固定大小为 8 的线程池，并使用自定义的线程工厂命名线程
        return Executors.newFixedThreadPool(
                8, new NameThreadFactory("com.kuma.cloud.ccsr.remote.raft-cli"));
    }

    public static ScheduledExecutorService getScheduleExecutor() {
        return Executors.newScheduledThreadPool(
                8, new NameThreadFactory("com.kuma.cloud.ccsr.remote.raft-schedule"));
    }
}
