...
public class RatelimitAutoConfiguration implements InitializingBean {

    @Override
    public void afterPropertiesSet() throws Exception {
        LogUtils.started(RatelimitAutoConfiguration.class, StarterNameConstants.SEATA_STARTER);
    }
