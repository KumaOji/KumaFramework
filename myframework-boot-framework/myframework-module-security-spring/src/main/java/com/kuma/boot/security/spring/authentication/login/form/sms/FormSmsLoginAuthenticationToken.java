...
public class FormSmsLoginAuthenticationToken extends AbstractAuthenticationToken {
     ...
     */
    public FormSmsLoginAuthenticationToken(
            Object principal,
            String captcha,
            String type,
    ...
    public static FormSmsLoginAuthenticationToken unauthenticated(
            Object principal, String captcha, String type) {
        return new FormSmsLoginAuthenticationToken(principal, captcha, type);
    }

    public static FormSmsLoginAuthenticationToken authenticated(
            Object principal,
            String captcha,
            String type,
            Collection<? extends GrantedAuthority> authorities) {
