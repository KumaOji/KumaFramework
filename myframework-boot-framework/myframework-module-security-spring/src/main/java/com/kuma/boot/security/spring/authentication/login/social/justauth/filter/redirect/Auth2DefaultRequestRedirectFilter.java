...
public class Auth2DefaultRequestRedirectFilter extends OncePerRequestFilter {
    ...
    /**
     * Constructs an {@code Auth2DefaultRequestRedirectFilter} using the provided parameters.
     *
    ...
    public Auth2DefaultRequestRedirectFilter(
        ...
        this.authorizationRequestResolver =
                new Auth2DefaultRequestResolver(authorizationRequestBaseUri);
    ...
    /**
     * Sets the {@link RequestCache} used for storing the current request before redirecting the
    ...
    protected void doFilterInternal(
        ...
        try {
            Auth2DefaultRequest authorizationRequest =
        ...
        try {
            ...
            AuthenticationException authzEx =
                    (AuthenticationException)
                            this.throwableAnalyzer.getFirstThrowableOfType(
    ...
    private void unsuccessfulRedirectForAuthorization(
            ...
            throws IOException {
        logger.error(LogMessage.format("Authorization Request failed: %s", ex, ex));
        response.sendError(
