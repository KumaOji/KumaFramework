...
public class WechatOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private static final ParameterizedTypeReference<com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User> OAUTH2_USER_OBJECT =
    ...
    @Override
    public com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User loadUser(OAuth2UserRequest userRequest)
        ...
        if (!StringUtils.hasText(openid)) {
            OAuth2Error oauth2Error =
                    new OAuth2Error(
                            MISSING_OPENID_ERROR_CODE,
                            "Missing required \"openid\" attribute in UserInfoEndpoint for Client"
                                    + " Registration: "
                                    + registrationId,
                            null);
            throw new OAuth2AuthenticationException(oauth2Error, oauth2Error.toString());
        }
        com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User wechatOAuth2User = getResponse(userRequest).getBody();
     ...
     * href="https://api.weixin.qq.com/sns/userinfo?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN">...</a>
     *
     * @param userRequest the user request
     * @return response
     */
    private ResponseEntity<com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User> getResponse(OAuth2UserRequest userRequest) {
        String userInfoUri =
                userRequest
    ...
    private static class WechatOAuth2UserHttpMessageConverter
            extends AbstractHttpMessageConverter<com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User> {
        ...
        protected boolean supports(Class<?> clazz) {
            return com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User.class.isAssignableFrom(clazz);
        }

        @Override
        protected com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User readInternal(
                Class<? extends com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User> clazz, HttpInputMessage inputMessage)
        ...
        protected void writeInternal(
                com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechat.WechatOAuth2User tokenResponse, HttpOutputMessage outputMessage)
