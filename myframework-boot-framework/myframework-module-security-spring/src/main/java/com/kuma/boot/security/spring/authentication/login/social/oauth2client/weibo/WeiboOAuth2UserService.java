...
public class WeiboOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest oAuth2UserRequest)
        ...
        com.kuma.boot.security.spring.authentication.login.social.oauth2client.weibo.WeiboOAuth2User weiboOAuth2User =
                restOperations.getForObject(userInfoUri, com.kuma.boot.security.spring.authentication.login.social.oauth2client.weibo.WeiboOAuth2User.class, params);
