...
public interface WechatMiniAppClientService {
     ...
     * @return {@link WechatMiniAppClient}
     * @see WechatMiniAppClient#getAppId() MiniAppClient#getAppId()
     * @see WechatMiniAppClient#getSecret() MiniAppClient#getSecret()
     */
    WechatMiniAppClient get(String clientId);
}
