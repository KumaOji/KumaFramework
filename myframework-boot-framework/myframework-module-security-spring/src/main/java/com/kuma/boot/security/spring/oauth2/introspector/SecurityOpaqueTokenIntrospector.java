...
public class SecurityOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
     ...
     * 日志记录器
     */
    private static final Logger logger = LoggerFactory.getLogger(SecurityOpaqueTokenIntrospector.class);
    /**
     * 其他操作
     */
     ...
     * @since 2023-07-04 10:00:05
     */
    public SecurityOpaqueTokenIntrospector(
            OAuth2EndpointProperties OAuth2EndpointProperties,
            OAuth2ResourceServerProperties resourceServerProperties) {
        this(
                getIntrospectionUri(OAuth2EndpointProperties, resourceServerProperties),
    ...
    private static String getIntrospectionUri(
            OAuth2EndpointProperties OAuth2EndpointProperties,
            OAuth2ResourceServerProperties resourceServerProperties) {
        String introspectionUri = OAuth2EndpointProperties.getTokenIntrospectionUri();
        ...
        claims.computeIfPresent(
                ...
                (k, v) -> {
                    if (v instanceof ArrayList) {
                        ...
                        values.forEach(value -> authorities.add(new KmcGrantedAuthority(value)));
                    }
                    return v;
                });
