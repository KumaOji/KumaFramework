...
public class GiteeOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest oAuth2UserRequest)
        ...
        com.kuma.boot.security.spring.authentication.login.social.oauth2client.gitee.GiteeOAuth2User giteeOAuth2User =
                restOperations
                        .exchange(url, HttpMethod.GET, entity, com.kuma.boot.security.spring.authentication.login.social.oauth2client.gitee.GiteeOAuth2User.class, params)
                        .getBody();
