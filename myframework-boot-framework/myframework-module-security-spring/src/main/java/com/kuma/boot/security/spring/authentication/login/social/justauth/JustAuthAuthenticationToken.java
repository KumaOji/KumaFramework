...
/**
 * An implementation of an {@link AbstractAuthenticationToken} that represents an OAuth 2.0
 * {@link Authentication}.
 * <p>
 * The {@link Authentication} associates an
 * {@link org.springframework.security.core.userdetails.UserDetails} {@code Principal} to the
 * identifier of the {@link #getProviderId() Authorized Client}, which the End-User
 * ({@code Principal}) granted authorization to so that it can access it's protected resources at
