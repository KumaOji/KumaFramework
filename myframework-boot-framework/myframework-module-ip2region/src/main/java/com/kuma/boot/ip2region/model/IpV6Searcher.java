...
public class IpV6Searcher {
    ...
    public com.kuma.boot.ip2region.model.IpInfo query(String ip) {
        return query(new com.kuma.boot.ip2region.model.IpAddress(ip));
    }

    public com.kuma.boot.ip2region.model.IpInfo query(com.kuma.boot.ip2region.model.IpAddress ip) {
    ...
    private long find(com.kuma.boot.ip2region.model.IpAddress ip, long l, long r) {
        if (l + 1 >= r) {
            return l;
        }
        long m = (l + r) / 2;
        byte[] mip = readRaw(indexStartOffset + m * (ipLen + offLen), ipLen);
        com.kuma.boot.ip2region.model.IpAddress aip = com.kuma.boot.ip2region.model.IpAddress.fromBytesV6LE(mip);
