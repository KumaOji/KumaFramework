...
public class RedisLimitHelper {
    ...
    static {
        ...
        SLIDING_WINDOW_LIMIT_SCRIPT.setScriptSource(
                new ResourceScriptSource(new ClassPathResource(SLIDING_WINDOW_LIMIT_SCRIPT_LUA)));
        SLIDING_WINDOW_LIMIT_SCRIPT.setResultType(Boolean.class);

        TOKEN_BUCKET_LIMIT_SCRIPT = new DefaultRedisScript<>();
        TOKEN_BUCKET_LIMIT_SCRIPT.setScriptSource(
                new ResourceScriptSource(new ClassPathResource(TOKEN_BUCKET_LIMIT_SCRIPT_LUA)));
        TOKEN_BUCKET_LIMIT_SCRIPT.setResultType(Boolean.class);
    }

    com.kuma.boot.ratelimit.ratelimitenhance.helper.RedisHelper redisHelper;

    public RedisLimitHelper(com.kuma.boot.ratelimit.ratelimitenhance.helper.RedisHelper redisHelper) {
