...
import com.kuma.boot.ratelimit.ratelimitenhance.annotation.SlideWindowLimit;
...
public class SlideWindowLimitAspect {
    ...
    @Pointcut(value="@annotation(com.kuma.boot.ratelimit.ratelimitenhance.annotation.SlideWindowLimit)")
    public void aspect() {
    }
