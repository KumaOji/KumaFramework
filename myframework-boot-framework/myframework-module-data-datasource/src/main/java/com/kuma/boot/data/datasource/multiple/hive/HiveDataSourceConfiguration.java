...
package com.kuma.boot.data.datasource.multiple.hive;
 ...
 */
@AutoConfiguration
@ConditionalOnClass(name = "org.apache.hive.jdbc.HiveDriver")
@ConditionalOnProperty(name = "kuma.boot.data.datasource.multiple.hive.enabled", havingValue = "true")
@Import(HiveJdbcBaseDaoImpl.class)
public class HiveDataSourceConfiguration {
    ...
    public HiveDataSourceConfiguration(
    ...
    public DataSource hiveDruidDataSource() {
        ...
        // 配置数据源属性
        datasource.setUrl(extDataSourceProperties.getHive().getUrl());
        datasource.setUsername(extDataSourceProperties.getHive().getUsername());
        datasource.setPassword(extDataSourceProperties.getHive().getPassword());
        datasource.setDriverClassName(extDataSourceProperties.getHive().getDriverClassName());
    ...
    @Bean(name = "hiveJdbcClient")
    public JdbcClient hiveJdbcClient( @Qualifier("hiveDruidDataSource") DataSource dataSource ) {
