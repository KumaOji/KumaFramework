...
import com.kuma.boot.data.mybatis.mybatisplus.injector.MateSqlMethod;
...
public class AbstractInsertMethod extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(
                ...
                if (null != tableInfo.getKeySequence()) {
                    keyGenerator =
                            TableInfoHelper.genKeyGenerator(
                                    sqlMethod.getMethod(), tableInfo, builderAssistant);
                    keyProperty = tableInfo.getKeyProperty();
                    keyColumn = tableInfo.getKeyColumn();
                }
            }
        ...
        String sql =
                String.format(
                        sqlMethod.getSql(), tableInfo.getTableName(), columnScript, valuesScript);
