...
public abstract class AbstractChineseCaptcha
extends BaseCaptcha {
    ...
    protected char[] alphas() {
        ...
        for (int i = 0; i < this.len; ++i) {
            cs[i] = AbstractChineseCaptcha.alphaHan();
        }
    ...
    public static char alphaHan() {
        return DELTA.charAt(AbstractChineseCaptcha.num(DELTA.length()));
    }
    ...
    public void drawLine(int num, Color color, Graphics2D g) {
        for (int i = 0; i < num; ++i) {
            ...
            int x1 = AbstractChineseCaptcha.num(-10, this.width / 3);
            int y1 = AbstractChineseCaptcha.num(5, this.height - 5);
            int x2 = AbstractChineseCaptcha.num(this.width / 3 * 2, this.width + 10);
            int y2 = AbstractChineseCaptcha.num(2, this.height - 2);
