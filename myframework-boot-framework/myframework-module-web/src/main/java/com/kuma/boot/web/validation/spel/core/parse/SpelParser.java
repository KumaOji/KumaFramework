...
public class SpelParser {
    ...
    private static void init() {
        ...
        if (applicationContext != null) {
            ...
            LogUtils.info("ApplicationContext is null, SpelParser will not support spring bean reference");
            LogUtils.info("If you want to use spring bean reference in SpelParser, please use @EnableSpelValidatorBeanRegistrar to enable ApplicationContext support");
        }
        LogUtils.debug("SpelParser init success");
    }
    ...
    public static Object parse(@Language("spel") String expression, Object rootObject) {
        try {
            LogUtils.debug("======> Parse expression [{}]", expression);
            ...
            LogUtils.debug("======> Parse result [{}]", value);
            return value;
