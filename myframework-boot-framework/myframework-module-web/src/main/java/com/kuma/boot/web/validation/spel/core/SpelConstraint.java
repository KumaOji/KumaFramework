...
/**
 * 将注解标记为由 {@link com.kuma.boot.web.validation.spel.validator.javax.SpelValid} 进行校验的Bean验证约束。
 * <p>
 ...
 *     当分组信息不为空时，只有当 {@link com.kuma.boot.web.validation.spel.validator.javax.SpelValid#spelGroups()} 中的分组信息与此处的分组信息有交集时，才会对带注解的元素进行校验。
 ...
 * 这里有一些定义约束的例子，可以参考：
 * <ul>
 *     <li>{@link SpelAssert}</li>
 *     <li>{@link SpelNotNull}</li>
 * </ul>
 *
 * @author 阿杆
 * @version 1.0
 * @see com.kuma.boot.web.validation.spel.validator.javax.SpelValid
