...
import com.kuma.boot.web.validation.spel.validator.constraintvalidator.SpelMaxValidator;
...
public @interface SpelMax {
    public String message() default "{com.kuma.boot.web.validation.spel.validator.constraint.Max.message}";
