...
public class Validator {
    ...
    public Validator notNull(String paramName) {
        cn.hutool.core.lang.Validator.validateNotNull(
                param, StrUtil.format(NOT_NULL_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator notEmpty(String paramName) {
        cn.hutool.core.lang.Validator.validateNotEmpty(
                param, StrUtil.format(NOT_EMPTY_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator assertTrue(String paramName) {
        cn.hutool.core.lang.Validator.validateTrue(
                (boolean) param, StrUtil.format(ASSERT_TRUE_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator assertFalse(String paramName) {
        cn.hutool.core.lang.Validator.validateFalse(
                (boolean) param, StrUtil.format(ASSERT_FALSE_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator digits(Number min, Number max, String paramName) {
        cn.hutool.core.lang.Validator.validateBetween(
                (Number) param, min, max, StrUtil.format(DIGITS_HINT_MSG, paramName, min, max));
        return this;
    }
    ...
    public Validator chinese(String paramName) {
        cn.hutool.core.lang.Validator.validateChinese(
                (CharSequence) param, StrUtil.format(CHINESE_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator english(String paramName) {
        cn.hutool.core.lang.Validator.validateWord(
                (CharSequence) param, StrUtil.format(ENGLISH_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator birthday(String paramName) {
        ...
        cn.hutool.core.lang.Validator.validateBirthday(
                date, StrUtil.format(BIRTHDAY_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator cellphone(String paramName) {
        cn.hutool.core.lang.Validator.validateMobile(
                (CharSequence) param, StrUtil.format(CELLPHONE_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator email(String paramName) {
        cn.hutool.core.lang.Validator.validateEmail(
                (CharSequence) param, StrUtil.format(EMAIL_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator idCard(String paramName) {
        cn.hutool.core.lang.Validator.validateCitizenIdNumber(
                (CharSequence) param, StrUtil.format(ID_CARD_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator plateNumber(String paramName) {
        cn.hutool.core.lang.Validator.validatePlateNumber(
                (CharSequence) param, StrUtil.format(PLATE_NUMBER_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator uuid(String paramName) {
        cn.hutool.core.lang.Validator.validateUUID(
                (CharSequence) param, StrUtil.format(UUID_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator url(String paramName) {
        cn.hutool.core.lang.Validator.validateUrl(
                (CharSequence) param, StrUtil.format(URL_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator ipv4(String paramName) {
        cn.hutool.core.lang.Validator.validateIpv4(
                (CharSequence) param, StrUtil.format(IPV4_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator ipv6(String paramName) {
        cn.hutool.core.lang.Validator.validateIpv6(
                (CharSequence) param, StrUtil.format(IPV6_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator macAddress(String paramName) {
        cn.hutool.core.lang.Validator.validateMac(
                (CharSequence) param, StrUtil.format(MAC_ADDRESS_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator carDrivingLicence(String paramName) {
        cn.hutool.core.lang.Validator.validateCarDrivingLicence(
                (CharSequence) param, StrUtil.format(CAR_DRIVING_LICENCE_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator carVin(String paramName) {
        cn.hutool.core.lang.Validator.validateCarVin(
                (CharSequence) param, StrUtil.format(CAR_VIN_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator zipCode(String paramName) {
        cn.hutool.core.lang.Validator.validateZipCode(
                (CharSequence) param, StrUtil.format(ZIP_CODE_HINT_MSG, paramName));
        return this;
    }
    ...
    public Validator regex(String regex, String paramName) {
        cn.hutool.core.lang.Validator.validateMatchRegex(
                regex, (CharSequence) param, StrUtil.format(REGEX_HINT_MSG, paramName, regex));
        return this;
    }
    ...
    public Validator valid(Object param, Class<?>... groups) {
        Set<ConstraintViolation<Object>> violations =
                ContextUtils.getBean(jakarta.validation.Validator.class, true)
        ...
        if (!violations.isEmpty()) {
            ...
            violations.forEach(
                    violation -> {
                        ...
                        LogUtils.error(errorHint.toString(JSONWriter.Feature.WriteMapNullValue));
                    });
