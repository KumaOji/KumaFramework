...
@InnerApi
public abstract class BaseInnerController<S extends BaseSuperService<T, I>, T extends SuperEntity<T, I>, I extends Serializable> implements BaseController<T, I> {
