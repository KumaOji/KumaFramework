...
public class GroovyScriptExpressionEngine implements ExpressionEngine {
   ...
   public Object evaluate(String expression, Map<String, Object> context) throws ExpressionException {
      ...
      try {
         ...
         LogUtils.debug("Groovy script '{}' evaluated to: {}", expression, result);
         return result;

      } catch (Exception e) {
         LogUtils.error("Failed to evaluate Groovy script: {}", expression, e);
   ...
   public boolean isValidExpression(String expression) {
      ...
      try {
         ...
         LogUtils.debug("Invalid Groovy script: {}", expression, e);
         return false;
      }
   }
   ...
   public void clearCache() {
      scriptCache.clear();
      LogUtils.debug("Groovy script cache cleared");
   }
