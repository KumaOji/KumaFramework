...
public class DefaultServiceRegistry implements ServiceRegistry {
   ...
   public <T> void registerService(String name, T service) {
      ...
      LogUtils.info("Registered service: {} -> {} ({})", name, serviceClass.getSimpleName(), serviceClass.getName());
   }
   ...
   public <T> Optional<T> removeService(String name) {
      ...
      if (service != null) {
         ...
         LogUtils.info("Removed service: {}", name);
   ...
   public void clear() {
      ...
      LogUtils.info("Cleared all registered services");
   }
