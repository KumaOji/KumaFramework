...
public class ChainExpressionEngine implements ExpressionEngine {
   ...
   public Object evaluate(String expression, Map<String, Object> context) throws ExpressionException {
      ...
      try {
         ...
         LogUtils.error("Failed to evaluate chain expression: {}", expression, e);
         throw new ExpressionException("Failed to evaluate expression: " + expression, e);
      }
   }

   /**
    * 评估THEN表达式 语法：THEN(a, b, c, d)
    */
   ...
   /**
    * 评估IF表达式 语法：IF(condition, trueComponent, falseComponent)
    */
   ...
   /**
    * 评估SWITCH表达式 语法：SWITCH(condition, case1:component1, case2:component2, default:defaultComponent)
    */
