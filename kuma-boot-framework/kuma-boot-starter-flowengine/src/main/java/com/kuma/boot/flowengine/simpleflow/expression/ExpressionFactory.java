...
import com.kuma.boot.flowengine.simpleflow.expression.evaluator.*;
...
public class ExpressionFactory {
   ...
   public static ExpressionEngine createEngine(String engineType, Map<String, Object> configuration) {
      ...
      return engineCache.computeIfAbsent(cacheKey, key -> {
         LogUtils.debug("Creating expression engine: {}", finalEngineType);
         ...
         switch (finalEngineType.toLowerCase()) {
            ...
            default:
               LogUtils.warn("Unknown engine type: {}, using default JEXL engine", finalEngineType);
               return new JexlExpressionEngine();
         }
      });
   }
   ...
   public static ExpressionParser createParser(String parserType, Map<String, Object> configuration) {
      ...
      return parserCache.computeIfAbsent(cacheKey, key -> {
         LogUtils.debug("Creating expression parser: {}", finalParserType);
         ...
         switch (finalParserType.toLowerCase()) {
            ...
            default:
               LogUtils.warn("Unknown parser type: {}, using default JEXL parser", finalParserType);
               return new JexlExpressionParser();
         }
      });
   }
   ...
   public static void setDefaultEngine( ExpressionEngine engine) {
      ...
      LogUtils.info("Default expression engine set to: {}", engine != null ? engine.getEngineName() : "null");
   }
   ...
   public static void setDefaultParser( ExpressionParser parser) {
      ...
      LogUtils.info("Default expression parser set to: {}", parser != null ? parser.getParserName() : "null");
   }
    ...
    * @throws ExpressionException 如果解析或执行失败
    */
   public static <T> T evaluate(String expressionString, Map<String, Object> context, Class<T> expectedType)
    ...
    * @throws ExpressionException 如果解析或执行失败
    */
   public static <T> T evaluate(String expressionString, ExpressionContext context, Class<T> expectedType)
           throws ExpressionException {
   ...
   public static void clearCache() {
      engineCache.clear();
      parserCache.clear();
      LogUtils.info("Expression factory cache cleared");
   }
   ...
   public static String[] getSupportedEngineTypes() {
      return new String[]{"jexl", "spel", "groovy", "groovy-script", "kotlin", "kotlin-script", "kts", "chain",
              "chain-expression"};
   }
