...
public class RateLimiterRuleBuilder {
    private com.kuma.boot.ratelimit.ratelimitsnowjean.commoon.entity.RateLimiterRule rateLimiterRule;

    public RateLimiterRuleBuilder() {
        this.rateLimiterRule = new com.kuma.boot.ratelimit.ratelimitsnowjean.commoon.entity.RateLimiterRule();
    }
     ...
     * 构建限流规则对象
     */
    public com.kuma.boot.ratelimit.ratelimitsnowjean.commoon.entity.RateLimiterRule build() {
        RateLimiterRuleBuilder.check(this.rateLimiterRule);
        return this.rateLimiterRule;
    }

    public static void check(com.kuma.boot.ratelimit.ratelimitsnowjean.commoon.entity.RateLimiterRule rateLimiterRule) {
