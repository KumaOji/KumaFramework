...
public class MongoHelper {
   ...
   @Autowired protected MongoConverter mongoConverter;
   ...
   private void logQuery(Class<?> clazz, Query query, Long startTime) {
      ...
      MongoPersistentEntity<?> entity =
              mongoConverter.getMappingContext().getPersistentEntity(clazz);
   ...
   private void logUpdate(
      ...
      Document mappedUpdate =
              updateMapper.getMappedObject(updateBuilder.toUpdate().getUpdateObject(), entity);
         ...
         for (Field field : fields) {
            if (!field.getName().equals(Constant.ID)
               ...
               ReflectUtil.setFieldValue(
                       objectOrg, field, ReflectUtil.getFieldValue(object, field));
            }
         }
   ...
   public void updateFirst(
           CriteriaWrapper criteriaWrapper, UpdateBuilder updateBuilder, Class<?> clazz) {
   ...
   public void updateMulti(
      ...
      mongoTemplate.updateMulti(
              new Query(criteriaWrapper.build()), updateBuilder.toUpdate(), clazz);
    ...
    */
   public <R, E> void addCountById(
           String id, SerializableFunction<E, R> property, Number count, Class<?> clazz) {
    ...
    * @return T 对象
    */
   public <T> T findOneByQuery(
           CriteriaWrapper criteriaWrapper, SortBuilder sortBuilder, Class<T> clazz) {
    ...
    * @return List 列表
    */
   public <T> List<T> findListByQuery(
           CriteriaWrapper criteriaWrapper, SortBuilder sortBuilder, Class<T> clazz) {
      Query query = new Query(criteriaWrapper.build());
      query.with(sortBuilder.toSort());
    ...
    * @return List 列表
    */
   public <T, R, E> List<T> findPropertiesByQuery(
           CriteriaWrapper criteriaWrapper,
           Class<?> documentClass,
      ...
      List<T> propertyList =
              extractProperty(list, ReflectionUtil.getFieldName(property), propertyClass);
      return propertyList;
   }
    ...
    * @return List 列表
    */
   public <R, E> List<String> findPropertiesByQuery(
           CriteriaWrapper criteriaWrapper,
           Class<?> documentClass,
           SerializableFunction<E, R> property) {
    ...
    * @return List 列表
    */
   public <R, E> List<String> findPropertiesByIds(
           List<String> ids, Class<?> clazz, SerializableFunction<E, R> property) {
    ...
    * @return List 列表
    */
   public <T> List<T> findListByIds(
           Collection<String> ids, SortBuilder sortBuilder, Class<T> clazz) {
      CriteriaAndWrapper criteriaAndWrapper = new CriteriaAndWrapper().in(Constant::getId, ids);
