...
public class CriteriaOrWrapper extends CriteriaWrapper {
    ...
    */
   @Override
   public <E, R> CriteriaOrWrapper containOr(
    ...
    */
   @Override
   public <E, R> CriteriaOrWrapper containAnd(
           SerializableFunction<E, R> column, Collection<?> params) {
      super.containAnd(column, params);
      return this;
   }
    ...
    * @since 2022-05-27 21:53:16
    */
   public <E, R> CriteriaOrWrapper findArray(
    ...
    * @since 2022-05-27 21:53:16
    */
   public <E, R> CriteriaOrWrapper findArrayLike(
           SerializableFunction<E, R> arr, SerializableFunction<E, R> column, String param) {
