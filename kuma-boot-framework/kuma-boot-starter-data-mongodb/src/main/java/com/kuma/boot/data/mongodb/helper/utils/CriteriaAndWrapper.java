...
public class CriteriaAndWrapper extends CriteriaWrapper {
    ...
    * @since 2022-05-27 21:52:48
    */
   public <E, R> CriteriaAndWrapper containOr(
    ...
    */
   @Override
   public <E, R> CriteriaAndWrapper containAnd(
           SerializableFunction<E, R> column, Collection<?> params) {
      super.containAnd(column, params);
      return this;
   }
   ...
   @Override
   public <E, R> CriteriaAndWrapper containAnd(
           SerializableFunction<E, R> column, Object[] params) {
      super.containAnd(column, params);
      return this;
   }
    ...
    * @since 2022-05-27 21:52:48
    */
   public <E, R> CriteriaAndWrapper findArray(
           SerializableFunction<E, R> arr, SerializableFunction<E, R> column, String param) {
    ...
    * @since 2022-05-27 21:52:48
    */
   public <E, R> CriteriaAndWrapper findArrayLike(
           SerializableFunction<E, R> arr, SerializableFunction<E, R> column, String param) {
