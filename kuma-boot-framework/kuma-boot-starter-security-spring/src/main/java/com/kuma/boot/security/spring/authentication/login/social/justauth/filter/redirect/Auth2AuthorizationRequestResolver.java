...
/**
 * Implementations of this interface are capable of resolving an {@link OAuth2AuthorizationRequest}
 * from the provided {@code HttpServletRequest}. Used by the
 * {@link Auth2DefaultRequestRedirectFilter} for resolving Authorization Requests.
 *
 * @author Joe Grandja
 * @author Rob Winch
 * @author YongWu zheng
...
public interface Auth2AuthorizationRequestResolver {
    ...
    /**
     * Returns the {@link Auth2DefaultRequest} resolved from the provided {@code HttpServletRequest}
     * or {@code null} if not available.
     *
     * @param request the {@code HttpServletRequest}
     * @return the resolved {@link Auth2DefaultRequest} or {@code null} if not available
     */
