...
public class JsonExtensionLoginAuthenticationFailureHandler
    ...
    public void onAuthenticationFailure(
        ...
        //			OAuth2AuthenticationException authorizationException = (OAuth2AuthenticationException)
        // exception;
        ...
        //		}
        //
        //		this.errorHttpResponseConverter.write(R.failed(errorMessage),
        ...
        if (exception
                instanceof
                IllegalParameterExtensionLoginException illegalParameterExtensionLoginException) {
