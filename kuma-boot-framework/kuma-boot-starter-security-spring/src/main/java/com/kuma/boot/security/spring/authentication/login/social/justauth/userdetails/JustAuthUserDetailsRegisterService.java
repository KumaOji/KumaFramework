...
/**
 * 用户名密码注册、手机短信登录与 OAuth 登录的用户注册接口.<br><br> 推荐通过继承来实现 此接口的功能
 */
public interface JustAuthUserDetailsRegisterService {
    ...
    //	default UserDetails registerUser(@NonNull AuthUser authUser, @NonNull String username,
    // @NonNull String
    // defaultAuthority) throws RegisterUserFailureException {
