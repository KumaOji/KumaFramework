 ...
 */
public class SignInFailureLimitedStampManager extends com.kuma.boot.security.spring.authentication.stamp.AbstractCountStampManager
     ...
     *
     * @param username 用户名
     * @return {@link com.kuma.boot.security.spring.authentication.stamp.SignInErrorStatus }
     * @since 2023-07-10 17:25:16
     */
    public com.kuma.boot.security.spring.authentication.stamp.SignInErrorStatus errorStatus(String username) {
        ...
        com.kuma.boot.security.spring.authentication.stamp.SignInErrorStatus status = new com.kuma.boot.security.spring.authentication.stamp.SignInErrorStatus();
