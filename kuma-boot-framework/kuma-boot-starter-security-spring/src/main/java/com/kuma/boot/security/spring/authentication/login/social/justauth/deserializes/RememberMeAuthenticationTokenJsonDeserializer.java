...
public class RememberMeAuthenticationTokenJsonDeserializer
    ...
    @Override
    public RememberMeAuthenticationToken deserialize(JsonParser p, DeserializationContext ctxt)
...
//        JsonMapper mapper = (JsonMapper) p.getCodec();
        ...
        try {
            ...
            final String msg =
                    String.format(
                            "RememberMeAuthenticationToken Jackson 反序列化错误: principal 反序列化错误: %s",
