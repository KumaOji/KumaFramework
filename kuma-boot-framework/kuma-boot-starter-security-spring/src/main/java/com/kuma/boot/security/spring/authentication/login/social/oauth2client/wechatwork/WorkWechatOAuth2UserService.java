...
public class WorkWechatOAuth2UserService
    ...
    private static final ParameterizedTypeReference<com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User> OAUTH2_USER_OBJECT =
    ...
    @Override
    public com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User loadUser(OAuth2UserRequest userRequest)
     ...
     * @return response
     */
    private ResponseEntity<com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User> getResponse(OAuth2UserRequest userRequest) {
        String userInfoUri =
                userRequest
    ...
    private static class WechatOAuth2UserHttpMessageConverter
            extends AbstractHttpMessageConverter<com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User> {
        ...
        protected boolean supports(Class<?> clazz) {
            return com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User.class.isAssignableFrom(clazz);
        }

        @Override
        protected com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User readInternal(
                Class<? extends com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User> clazz, HttpInputMessage inputMessage)
        ...
        protected void writeInternal(
                com.kuma.boot.security.spring.authentication.login.social.oauth2client.wechatwork.WorkWechatOAuth2User tokenResponse, HttpOutputMessage outputMessage)
