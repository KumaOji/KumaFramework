...
public class OneClickLoginAuthenticationToken extends AbstractAuthenticationToken {
     ...
     */
    public OneClickLoginAuthenticationToken(
            @NonNull String mobile, @Nullable Map<String, String> otherParamMap) {
     ...
     * producing a trusted (i.e. {@link #isAuthenticated()} = <codes>true</codes>) auth token.
     *
    ...
    public static OneClickLoginAuthenticationToken unauthenticated(
            String mobile, Map<String, String> otherParamMap) {
        return new OneClickLoginAuthenticationToken(mobile, otherParamMap);
    }

    public static OneClickLoginAuthenticationToken unauthenticated(
            String mobile, Map<String, String> otherParamMap, ServletWebRequest request) {
        return new OneClickLoginAuthenticationToken(mobile, otherParamMap, request);
    }

    public static OneClickLoginAuthenticationToken authenticated(
            @NonNull Object principal,
            @Nullable Map<String, String> otherParamMap,
            @NonNull Collection<? extends GrantedAuthority> authorities) {
