...
/**
 * <p>本地RequestMapping收集事件
 *
 * @author : gengwei.zheng
 * @since : 2021/8/8 21:55
 */
public class LocalRequestMappingGatherEvent extends com.kuma.boot.security.spring.event.LocalApplicationEvent<List<RequestMapping>> {
