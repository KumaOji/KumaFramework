...
public class FingerprintAuthenticationProvider
    ...
    protected Authentication createSuccessAuthentication(
        ...
        String fingerPrint = "";
        if (authentication
                instanceof FingerprintAuthenticationToken fingerprintAuthenticationToken) {
    ...
    protected void additionalAuthenticationChecks(
            UserDetails userDetails, FingerprintAuthenticationToken authentication)
            throws AuthenticationException {
    ...
    protected final UserDetails retrieveUser(
            String username, FingerprintAuthenticationToken authentication)
            throws AuthenticationException {
        prepareTimingAttackProtection();
        try {
            UserDetails loadedUser =
                    fingerprintUserDetailsService.loadUserByFingerprint(
