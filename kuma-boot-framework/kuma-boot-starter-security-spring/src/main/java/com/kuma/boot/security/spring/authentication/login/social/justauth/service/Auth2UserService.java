...
/**
 * Implementations of this interface are responsible for obtaining the user attributes of the
 * End-User (Resource Owner) from the UserInfo Endpoint using the
...
public interface Auth2UserService {
    ...
    /**
     * Returns an {@link AuthUser} after obtaining the user attributes of the End-User from the
     * UserInfo Endpoint.
     *
     * @param auth2Request the user OAuth2 request
     * @param request      HttpServletRequest
     * @return an {@link AuthUser}
     * @throws OAuth2AuthenticationException if an error occurs while attempting to obtain the user
