 ...
 */
public class SysAttributeChangeEvent extends LocalApplicationEvent<KmcAttribute> {

    public SysAttributeChangeEvent(KmcAttribute data) {
        super(data);
    }

    public SysAttributeChangeEvent(KmcAttribute data, Clock clock) {
        super(data, clock);
    }
}
