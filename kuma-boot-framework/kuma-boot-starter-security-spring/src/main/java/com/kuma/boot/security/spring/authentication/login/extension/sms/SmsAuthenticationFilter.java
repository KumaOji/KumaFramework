...
public class SmsAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final PathPatternRequestMatcher DEFAULT_ANT_PATH_REQUEST_MATCHER =
            PathPatternRequestMatcher.withDefaults().matcher(HttpMethod.POST, "/login/sms");
    ...
    private Converter<HttpServletRequest, SmsAuthenticationToken>
    ...
    public Converter<HttpServletRequest, SmsAuthenticationToken>
    ...
    public void setCaptchaAuthenticationTokenConverter(
            Converter<HttpServletRequest, SmsAuthenticationToken>
                    captchaAuthenticationTokenConverter) {
