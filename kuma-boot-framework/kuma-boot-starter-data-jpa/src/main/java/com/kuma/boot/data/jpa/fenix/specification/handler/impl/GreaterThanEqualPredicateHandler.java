...
import com.kuma.boot.data.jpa.fenix.specification.annotation.GreaterThanEqual;
...
public class GreaterThanEqualPredicateHandler extends AbstractPredicateHandler {
   public GreaterThanEqualPredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.and(new Predicate[]{super.buildGreaterThanEqualPredicate(criteriaBuilder, from, fieldName, value)});
   }
}
