...
import com.kuma.boot.data.jpa.fenix.specification.annotation.OrNotLike;
...
public class OrNotLikePredicateHandler extends AbstractPredicateHandler {
   public OrNotLikePredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.or(new Predicate[]{super.buildNotLikePredicate(criteriaBuilder, from, fieldName, value)});
   }
}
