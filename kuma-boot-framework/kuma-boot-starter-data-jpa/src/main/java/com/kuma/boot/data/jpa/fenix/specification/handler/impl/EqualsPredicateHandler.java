...
import com.kuma.boot.data.jpa.fenix.specification.annotation.Equals;
...
public class EqualsPredicateHandler extends AbstractPredicateHandler {
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.and(new Predicate[]{super.buildEqualsPredicate(criteriaBuilder, from, fieldName, value)});
   }
}
