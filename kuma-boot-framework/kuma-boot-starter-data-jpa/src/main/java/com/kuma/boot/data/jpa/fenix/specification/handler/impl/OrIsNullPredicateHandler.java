...
import com.kuma.boot.data.jpa.fenix.specification.annotation.OrIsNull;
...
public class OrIsNullPredicateHandler extends AbstractPredicateHandler {
   public OrIsNullPredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.or(new Predicate[]{super.buildIsNullPredicate(criteriaBuilder, from, value)});
   }
}
