...
import com.kuma.boot.data.jpa.fenix.specification.annotation.OrNotIn;
...
public class OrNotInPredicateHandler extends AbstractPredicateHandler {
   public OrNotInPredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.or(new Predicate[]{criteriaBuilder.not(super.buildInPredicate(criteriaBuilder, from, fieldName, value, super.isAllowNull(annotation)))});
   }

   public Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<?, ?> from, String fieldName, Object value) {
      return criteriaBuilder.or(new Predicate[]{criteriaBuilder.not(super.buildInPredicate(criteriaBuilder, from, fieldName, value, false))});
   }
}
