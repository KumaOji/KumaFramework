...
import com.kuma.boot.data.jpa.fenix.specification.annotation.NotEquals;
...
public class NotEqualsPredicateHandler extends AbstractPredicateHandler {
   public NotEqualsPredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.and(new Predicate[]{super.buildNotEqualsPredicate(criteriaBuilder, from, fieldName, value)});
   }
}
