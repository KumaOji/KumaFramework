...
import com.kuma.boot.data.jpa.fenix.specification.annotation.OrNotEndsWith;
...
public class OrNotEndsWithPredicateHandler extends AbstractPredicateHandler {
   public OrNotEndsWithPredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.or(new Predicate[]{super.buildNotEndsWithPredicate(criteriaBuilder, from, fieldName, value)});
   }
}
