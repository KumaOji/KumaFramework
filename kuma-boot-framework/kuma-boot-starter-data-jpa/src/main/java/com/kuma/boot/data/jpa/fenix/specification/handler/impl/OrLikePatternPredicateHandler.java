...
import com.kuma.boot.data.jpa.fenix.specification.annotation.OrLikePattern;
...
public class OrLikePatternPredicateHandler extends AbstractPredicateHandler {
   public OrLikePatternPredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.or(new Predicate[]{super.buildLikePatternPredicate(criteriaBuilder, from, fieldName, value)});
   }
}
