...
import com.kuma.boot.data.jpa.fenix.specification.annotation.NotEndsWith;
...
public class NotEndsWithPredicateHandler extends AbstractPredicateHandler {
   public NotEndsWithPredicateHandler() {
   }
   ...
   public <Z, X> Predicate buildPredicate(CriteriaBuilder criteriaBuilder, From<Z, X> from, String fieldName, Object value, Annotation annotation) {
      return criteriaBuilder.and(new Predicate[]{super.buildNotEndsWithPredicate(criteriaBuilder, from, fieldName, value)});
   }
}
