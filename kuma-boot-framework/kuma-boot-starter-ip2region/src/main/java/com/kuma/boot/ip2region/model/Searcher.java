...
public class Searcher {
    ...
    public static com.kuma.boot.ip2region.model.Header loadHeader(RandomAccessFile handle) throws IOException {
        handle.seek(0);
        final byte[] buff = new byte[HEADER_INFO_LENGTH];
        handle.read(buff);
        return new com.kuma.boot.ip2region.model.Header(buff);
    }

    public static com.kuma.boot.ip2region.model.Header loadHeaderFromFile(String dbPath) throws IOException {
