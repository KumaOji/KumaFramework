...
public class Ip2regionAutoConfiguration implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        LogUtils.started(Ip2regionAutoConfiguration.class, StarterNameConstants.IP2REGION_STARTER);
    }
    ...
    //	//
    //	////缓存 VectorIndex 索引
    //	////我们可以提前从 xdb 文件中加载出来 VectorIndex 数据，然后全局缓存，每次创建 Searcher 对象的时候使用全局的 VectorIndex
