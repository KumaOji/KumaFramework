...
public class JDFrameImpl<T> extends AbstractDataFrameImpl<T> implements JDFrame<T> {
    ...
    public JDFrameImpl(List<T> list) {
        ...
        /*
         * else { // update reference ，do not affect the original list list = new
         * ArrayList<>(list); }
         */
    ...
    @Override
    public <R extends Number> JDFrameImpl<T> mapPercent(
    ...
    @Override
    public <R, K> JDFrameImpl<R> leftJoinOnce(
    ...
    @Override
    public <K> JDFrameImpl<T> leftJoinOnceVoid(
            IFrame<K> other, JoinOn<T, K> on, VoidJoin<T, K> join) {
    ...
    @Override
    public <R, K> JDFrameImpl<R> rightJoinOnce(
            IFrame<K> other, JoinOn<T, K> on, Join<T, K, R> join) {
    ...
    @Override
    public JDFrameImpl<T> explodeJsonArray(
    ...
    @Override
    public <R extends Comparable<R>> JDFrame<T> distinct(
    ...
    public <R extends Comparable<R>> JDFrameImpl<T> whereBetween(
    ...
    @Override
    public <R extends Comparable<R>> JDFrameImpl<T> whereBetweenN(
            Function<T, R> function, R start, R end) {
        if (start == null && end == null) {
            return this;
        }
    ...
    public <R extends Comparable<R>> JDFrameImpl<T> whereBetweenR(
            Function<T, R> function, R start, R end) {
        if (start == null && end == null) {
            return this;
        }
    ...
    @Override
    public <R extends Comparable<R>> JDFrameImpl<T> whereBetweenL(
            Function<T, R> function, R start, R end) {
        if (start == null && end == null) {
            return this;
        }
    ...
    public <R extends Comparable<R>> JDFrameImpl<T> whereNotBetween(
            Function<T, R> function, R start, R end) {
        if (start == null || end == null) {
            return this;
        }
    ...
    @Override
    public <R extends Comparable<R>> JDFrameImpl<T> whereNotBetweenN(
            Function<T, R> function, R start, R end) {
        if (start == null || end == null) {
            return this;
        }
    ...
    @Override
    public <K, R extends Number> JDFrameImpl<FI2<K, BigDecimal>> groupBySum(
    ...
    @Override
    public <K, J, R extends Number> JDFrameImpl<FI3<K, J, BigDecimal>> groupBySum(
    ...
    @Override
    public <K, J, H, R extends Number> JDFrameImpl<FI4<K, J, H, BigDecimal>> groupBySum(
            Function<T, K> key,
            Function<T, J> key2,
            Function<T, H> key3,
    ...
    @Override
    public <K, J> JDFrameImpl<FI3<K, J, Long>> groupByCount(
    ...
    @Override
    public <K, J, H> JDFrameImpl<FI4<K, J, H, Long>> groupByCount(
    ...
    @Override
    public <K, R extends Number> JDFrameImpl<FI3<K, BigDecimal, Long>> groupBySumCount(
            Function<T, K> key, NumberFunction<T, R> value) {
    ...
    @Override
    public <K, J, R extends Number> JDFrameImpl<FI4<K, J, BigDecimal, Long>> groupBySumCount(
            Function<T, K> key, Function<T, J> key2, NumberFunction<T, R> value) {
        List<T> dataList = viewList();
        Collector<T, ?, BigDecimal> tBigDecimalCollector =
                CollectorsPlusUtil.summingBigDecimalForNumber(value);
    ...
    @Override
    public <K, R extends Number> JDFrameImpl<FI2<K, BigDecimal>> groupByAvg(
            Function<T, K> key, NumberFunction<T, R> value) {
        Collector<T, ?, BigDecimal> tBigDecimalCollector =
    ...
    @Override
    public <K, J, R extends Number> JDFrameImpl<FI3<K, J, BigDecimal>> groupByAvg(
            Function<T, K> key, Function<T, J> key2, NumberFunction<T, R> value) {
    ...
    @Override
    public <K, J, H, R extends Number> JDFrameImpl<FI4<K, J, H, BigDecimal>> groupByAvg(
            Function<T, K> key,
            Function<T, J> key2,
            Function<T, H> key3,
            NumberFunction<T, R> value) {
    ...
    @Override
    public <K, V extends Comparable<? super V>> JDFrameImpl<FI2<K, T>> groupByMax(
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, T>> groupByMax(
    ...
    @Override
    public <K, V extends Comparable<? super V>> JDFrameImpl<FI2<K, V>> groupByMaxValue(
            Function<T, K> key, Function<T, V> value) {
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, V>> groupByMaxValue(
            Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
        return groupByMax(key, key2, value)
                .map(e -> new FI3<>(e.getC1(), e.getC2(), getApplyValue(value, e.getC3())));
    }

    public <K, V extends Comparable<? super V>> JDFrameImpl<FI2<K, T>> groupByMin(
            Function<T, K> key, Function<T, V> value) {
        Map<K, T> collect =
                stream()
                        .collect(
                                groupingBy(
                                        key,
                                        collectingAndThen(toList(), getListMinFunction(value))));
        return returnDF(FrameUtil.toListFI2(collect));
    }

    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, T>> groupByMin(
            Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
    ...
    @Override
    public <K, V extends Comparable<? super V>> JDFrameImpl<FI2<K, V>> groupByMinValue(
            Function<T, K> key, Function<T, V> value) {
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, V>> groupByMinValue(
            Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
    ...
    @Override
    public <K, V extends Comparable<? super V>> JDFrameImpl<FI2<K, MaxMin<V>>> groupByMaxMinValue(
            Function<T, K> key, Function<T, V> value) {
        Map<K, MaxMin<V>> map =
                stream()
                        .collect(
    ...
    JDFrameImpl<FI3<K, J, MaxMin<V>>> groupByMaxMinValue(
            Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
    ...
    @Override
    public <K, V extends Comparable<? super V>> JDFrameImpl<FI2<K, MaxMin<T>>> groupByMaxMin(
            Function<T, K> key, Function<T, V> value) {
        Map<K, MaxMin<T>> map =
                stream()
                        .collect(
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, MaxMin<T>>> groupByMaxMin(
            Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
    ...
    public <F> JDFrameImpl<T> fi2Frame(
            JDFrameImpl<FI2<T, F>> frame, SetFunction<T, F> setFunction) {
    ...
    @Override
    public JDFrameImpl<T> overPercentRankS(
    ...
    @Override
    public JDFrameImpl<T> overCumeDistS(
            SetFunction<T, BigDecimal> setFunction, Window<T> overParam) {
    ...
    @Override
    public <F> JDFrameImpl<T> overLagS(
    ...
    @Override
    public <F> JDFrameImpl<T> overLeadS(
            SetFunction<T, F> setFunction, Window<T> overParam, Function<T, F> field, int n) {
    ...
    @Override
    public <F> JDFrameImpl<T> overFirstValueS(
    ...
    @Override
    public <F> JDFrameImpl<T> overLastValueS(
            SetFunction<T, F> setFunction, Window<T> overParam, Function<T, F> field) {
    ...
    @Override
    public <F> JDFrameImpl<T> overSumS(
    ...
    @Override
    public <F> JDFrameImpl<T> overAvgS(
            SetFunction<T, BigDecimal> setFunction, Window<T> overParam, Function<T, F> field) {
    ...
    @Override
    public <F extends Comparable<? super F>> JDFrameImpl<T> overMaxValueS(
            SetFunction<T, F> setFunction, Window<T> overParam, Function<T, F> field) {
    ...
    @Override
    public <F extends Comparable<? super F>> JDFrameImpl<T> overMinValueS(
            SetFunction<T, F> setFunction, Window<T> overParam, Function<T, F> field) {
    ...
    @Override
    public JDFrameImpl<T> overNtileS(
    ...
    /** ============================== Other =============== */
    @Override
    public <G, C> JDFrameImpl<T> replenish(
    ...
    @Override
    public <C> JDFrameImpl<T> replenish(
