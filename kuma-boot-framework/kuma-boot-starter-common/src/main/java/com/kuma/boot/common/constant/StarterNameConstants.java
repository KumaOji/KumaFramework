...
public final class StarterNameConstants {
    ...
    public static final String CLIENT_STARTER = "kuma-boot-starter-client";
    ...
    public static final String DATA_DATASOURCE_STARTER = "kuma-boot-starter-data-datasource";
    ...
    public static final String OSS_ALIYUN_STARTER = "kuma-boot-starter-oss-aliyun";
    public static final String OSS_COS_STARTER = "kuma-boot-starter-oss-cos";
    ...
    public static final String SECURITY_JSTAUTH_STARTER = "kuma-boot-starter-security-jstauth";
    ...
    public static final String TRACER_STARTER = "kuma-boot-starter-tracer";
