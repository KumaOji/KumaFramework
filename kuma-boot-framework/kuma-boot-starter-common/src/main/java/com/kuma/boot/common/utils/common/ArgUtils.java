...
public final class ArgUtils {
     ...
     * @param name 参数名称
     */
    public static void assertTrue(final boolean condition, final String name) {
        if (!condition) {
     ...
     * @param name 参数名称
     */
    public static void assertFalse(boolean condition, final String name) {
        if (condition) {
     ...
     */
    @Deprecated
    public static void gt(final long actual, final long expected) {
        gt("", actual, expected);
    }
     ...
     * @param expected 预期值
     */
    public static void gt(final String paramName, final long actual, final long expected) {
        if (actual > expected) {
            return;
        }
     ...
     * @param expected 预期值
     */
    public static void gte(final String paramName, final long actual, final long expected) {
        if (actual >= expected) {
            return;
        }
     ...
     * @param expected 预期值
     */
    public static void lt(final String paramName, final long actual, final long expected) {
        if (actual < expected) {
            return;
        }
     ...
     * @param expected 预期值
     */
    public static void lte(final String paramName, final long actual, final long expected) {
        if (actual <= expected) {
            return;
        }
