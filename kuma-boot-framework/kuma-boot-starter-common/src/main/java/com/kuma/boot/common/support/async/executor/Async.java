...
public class Async {
    ...
    public static boolean beginWork(
        ...
        CompletableFuture<Void>[] futures = new CompletableFuture[workerWrappers.size()];
    ...
    public static boolean beginWork(
        ...
        List<WorkerWrapper<?, ?>> workerWrappers =
                Arrays.stream(workerWrapper).collect(Collectors.toList());
    ...
    public static void beginWorkAsync(
            long timeout, IGroupCallback groupCallback, WorkerWrapper<?, ?>... workerWrapper) {
                    ...
                    () -> {
                        try {
                            ...
                            if (success) {
                                ...
                                finalGroupCallback.failure(
                                        Arrays.asList(workerWrapper), new TimeoutException());
                            }
     ...
     */
    @SuppressWarnings("unchecked")
    private static void totalWorkers(
            List<WorkerWrapper<?, ?>> workerWrappers, Set<WorkerWrapper<?, ?>> set) {
