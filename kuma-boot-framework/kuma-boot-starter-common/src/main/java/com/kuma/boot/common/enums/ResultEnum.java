...
import static com.kuma.boot.common.constant.CommonConstants.REQUEST_ERROR;
import static com.kuma.boot.common.constant.CommonConstants.REQUEST_FAILED;
import static com.kuma.boot.common.constant.CommonConstants.REQUEST_SUCCESS;
import static com.kuma.boot.common.model.Code.systemCode;
...
public enum ResultEnum implements CommonEnum {
    ...
    // *********************公共枚举参数************************
    SUCCESS(systemCode("0000"), REQUEST_SUCCESS),
    FAILED(systemCode("0001"), REQUEST_FAILED),
    PROCESSING(systemCode("0001"), REQUEST_FAILED),
    UNKNOWN(systemCode("0001"), REQUEST_FAILED),


    CHECK_ERROR(systemCode("500"), REQUEST_ERROR),
    SYSTEM_ERROR(systemCode("500"), REQUEST_ERROR),
    IO_ERROR(systemCode("500"), REQUEST_ERROR),
    NETWORK_ERROR(systemCode("500"), REQUEST_ERROR),
    NOT_FOUND_ERROR(systemCode("599008"), "数据不存在"),
    DATA_NOT_EXIST_ERROR(systemCode("599008"), "数据不存在"),
    LIMIT_ERROR(systemCode("429"), "数据不存在"),
    TIMEOUT_ERROR(systemCode("429"), "请求超时"),


    LOGIN_SUCCESS(systemCode("200"), "登录成功"),
    LOGOUT_SUCCESS(systemCode("200"), "退出成功"),
    BAD_REQUEST(systemCode("400"), "请求参数错误"),
    ILLEGAL_ARGUMENT_ERROR(systemCode("400"), "非法参数"),
    UNAUTHORIZED(systemCode("401"), "未授权禁止访问"),
    FORBIDDEN(systemCode("403"), "权限不足禁止访问"),
    REQUEST_NOT_FOUND(systemCode("404"), "请求不存在"),
    SQL_INJECTION_REQUEST(systemCode("405"), "疑似SQL注入请求"),
    BLACKLIST(systemCode("406"), "您已被拉入黑名单"),
    INNER_ERROR(systemCode("500"), "服务器内部错误，请联系管理员"),
    USER_AUTHORITY_ERROR(systemCode("500"), ""),
    HTTP_MESSAGE_NOT_READABLE(systemCode("500"), ""),
    MISSING_SERVLET_REQUEST_PARAMETER(systemCode("500"), ""),
    ...
    //
    //// ***********************系统异常**********************
    //USER_EDIT_SUCCESS(500001, "用户修改成功"),
    ...
    //HTTP_REQUEST_METHOD_NOT_SUPPORTED(500072, "请求method不匹配"),
    //HTTP_MESSAGE_NOT_READABLE(500073, "类型参数数据类型转换异常"),
    //// 微信
    //WECHAT_CONNECT_NOT_EXIST(500074, "微信联合登录未配置"),
    //VERIFICATION_EXIST(500075, "验证码服务异常"),
    //LIMIT_ERROR(500076, "访问过于频繁，请稍后再试"),
    //ILLEGAL_REQUEST_ERROR(500077, "非法请求，请重新刷新页面操作"),
    //IMAGE_FILE_EXT_ERROR(500078, "不支持图片格式"),
    //FILE_TYPE_NOT_SUPPORT(500079, "不支持上传的文件类型！"),
    //PLATFORM_NOT_SUPPORTED_IM(500080, "平台未开启IM"),
    //STORE_NOT_SUPPORTED_IM(500081, "店铺未开启IM"),
    //WECHAT_CONNECT_NOT_SETTING(500082, "微信联合登陆信息未配置"),
    //WECHAT_PAYMENT_NOT_SETTING(500083, "微信支付信息未配置"),
    //WECHAT_QRCODE_ERROR(500084, "微信二维码生成异常"),
    //WECHAT_MP_MESSAGE_ERROR(500085, "微信小程序小消息订阅异常"),
    //WECHAT_JSAPI_SIGN_ERROR(500086, "微信JsApi签名异常"),
    //WECHAT_CERT_ERROR(500087, "证书获取失败"),
    //WECHAT_MP_MESSAGE_TMPL_ERROR(500088, "未能获取到微信模版消息id"),
    //WECHAT_ERROR(500089, "微信接口异常"),
    //APP_VERSION_EXIST(500090, "APP版本已存在"),
    //
    //PERMISSION_DEPARTMENT_ROLE_ERROR(500091, "角色已绑定部门，请逐个删除"),
    //PERMISSION_USER_ROLE_ERROR(500092, "角色已绑定管理员，请逐个删除"),
    //PERMISSION_MENU_ROLE_ERROR(500093, "菜单已绑定角色，请先删除或编辑角色"),
    //PERMISSION_DEPARTMENT_DELETE_ERROR(500094, "部门已经绑定管理员，请先删除或编辑管理员"),
    //PERMISSION_BEYOND_TEN(500095, "最多可以设置10个角色"),
    //// 设置
    //SETTING_NOT_TO_SET(500096, "该参数不需要设置"),
    //ALIPAY_NOT_SETTING(500097, "支付宝支付未配置"),
    //ALIPAY_EXCEPTION(500098, "支付宝支付错误，请稍后重试"),
    //ALIPAY_PARAMS_EXCEPTION(500099, "支付宝参数异常"),
    //LOGISTICS_NOT_SETTING(500100, "您还未配置快递查询"),
    //ORDER_SETTING_ERROR(500101, "系统订单配置异常"),
    //Att_SMS_SETTING_ERROR(500102, "您还未配置阿里云短信"),
    //SMS_SIGN_EXIST_ERROR(500103, "短信签名已存在"),
    //// 验证码
    //VERIFICATION_SEND_SUCCESS(500104, "短信验证码,发送成功"),
    //VERIFICATION_ERROR(500105, "验证失败"),
    //VERIFICATION_CODE_INVALID(500106, "验证码已失效，请重新校验"),
    //VERIFICATION_SMS_CHECKED_ERROR(500107, "短信验证码错误，请重新校验"),
    //// OSS
    //OSS_NOT_EXIST(500108, "OSS未配置"),
    //OSS_EXCEPTION_ERROR(500109, "文件上传失败，请稍后重试"),
    //OSS_DELETE_ERROR(500110, "图片删除失败"),
    //
    //// **********************商品模块异常***********************
    //// 分类
    ...
    //
    //// *************************店铺模块异常********************
    //STORE_NOT_EXIST(513002, "此店铺不存在"),
    //STORE_NAME_EXIST_ERROR(513003, "店铺名称已存在!"),
    //STORE_APPLY_DOUBLE_ERROR(513004, "已有店铺，无需重复申请!"),
    //STORE_NOT_OPEN(513005, "该会员未开通店铺"),
    ...
    //NOTICE_ERROR(514002, "修改站内信异常，请稍后重试"),
    //NOTICE_SEND_ERROR(514003, "发送站内信异常，请检查系统日志");
    ...
    ResultEnum(Code code, String desc) {
        this.code = code;
        this.desc = desc;
    }
