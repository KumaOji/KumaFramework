package com.kuma.boot.monitor.alarm.core.helper;
...
public class ExecuteHelper {
   public static ExecuteHelper DEFAULT_EXECUTE;
   ...
   public static void setDefaultExecute(ExecuteHelper defaultExecute) {
   ...
   static {
      DEFAULT_EXECUTE = new ExecuteHelper(SimpleExecuteFactory.getExecute(NoneExecute.NAME), Collections.emptyList());
   }
}
