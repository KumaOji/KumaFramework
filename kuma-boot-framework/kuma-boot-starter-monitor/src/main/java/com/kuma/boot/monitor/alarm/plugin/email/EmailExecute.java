package com.kuma.boot.monitor.alarm.plugin.email;

import com.kuma.boot.monitor.alarm.core.execut.api.IExecute;
import com.kuma.boot.monitor.alarm.plugin.email.wrapper.EmailWrapper;
...
public class EmailExecute implements IExecute {
   ...
   public void sendMsg(List<String> users, String title, String msg) {
      try {
         ...
         logger.error("email send error! users: {}, title: {}, msg: {} e:{}", new Object[]{users, title, msg, e});
      }
