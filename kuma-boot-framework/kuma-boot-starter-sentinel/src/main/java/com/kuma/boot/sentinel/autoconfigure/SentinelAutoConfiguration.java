...
package com.kuma.boot.sentinel.autoconfigure;
...
import com.kuma.boot.sentinel.autoconfigure.properties.SentinelProperties;
...
@ConditionalOnProperty(
        prefix = SentinelProperties.PREFIX,
        name = "enabled",
        havingValue = "true",
        matchIfMissing = true)
public class SentinelAutoConfiguration implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        LogUtils.started(SentinelAutoConfiguration.class, StarterNameConstants.SENTINEL_STARTER);
    }
    ...
    public static class WebmvcHandler {
        ...
        public BlockExceptionHandler webmvcBlockExceptionHandler() {
            return (request, response, str, e) -> {
                ...
                Result<String> result = Result.fail("Too many request, please retry later.");
