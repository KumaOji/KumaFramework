...
public class LogContext {
    ...
    public static void setValidateObject(Object object) {
        ...
        if (object instanceof com.kuma.boot.web.validation.spel.test.util.ID) {
            MDC.put("id", String.valueOf(((com.kuma.boot.web.validation.spel.test.util.ID) object).getId()));
        }
    }
