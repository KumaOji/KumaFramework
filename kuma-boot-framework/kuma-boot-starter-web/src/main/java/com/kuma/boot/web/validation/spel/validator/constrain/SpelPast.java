...
import com.kuma.boot.web.validation.spel.validator.constraintvalidator.SpelPastValidator;
...
/**
 * 被标记的元素必须是一个过去的时间。{@code null} 元素被认为是有效的。
 * <p>
 * 支持的类型有：
 * <ul>
...
@Retention(RUNTIME)
@Target(FIELD)
@Repeatable(SpelPast.List.class)
@SpelConstraint(validatedBy = SpelPastValidator.class)
public @interface SpelPast {

    /**
     * 校验失败时的错误消息
     */
    String message() default "{com.kuma.boot.web.validation.spel.validator.constraint.Past.message}";
