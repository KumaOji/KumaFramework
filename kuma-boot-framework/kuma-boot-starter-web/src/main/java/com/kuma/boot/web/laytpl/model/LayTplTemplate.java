...
import com.kuma.boot.web.laytpl.js.JsLayTpl;
...
public class LayTplTemplate implements ApplicationContextAware, InitializingBean {
    ...
    private final Function<String, String> tplFunction =
            Unchecked.function(
                    tpl -> {
                        Resource resource =
                                LayTplTemplate.this.getApplicationContext().getResource(tpl);
    ...
    private final com.kuma.boot.web.laytpl.model.FmtFunc fmtFunc;
    private ApplicationContext applicationContext;
    private ScriptEngine engine;

    public LayTplTemplate( LayTplProperties tplProperties, com.kuma.boot.web.laytpl.model.FmtFunc fmtFunc) {
