 ...
 */
public class StringToEnumConverterFactory implements ConverterFactory<String, CommonEnum> {
    ...
    public <T extends CommonEnum> Converter<String, T> getConverter(Class<T> targetType) {
        ...
        if (converter == null) {
            converter = new com.kuma.boot.web.mvc.converter.StringToEnumConverter<>(targetType);
