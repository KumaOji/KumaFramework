...
/**
 * 被标记的元素必须是一个将来的时间。{@code null} 元素被认为是有效的。
 * <p>
 * 支持的类型有：
 * <ul>
...
@Retention(RUNTIME)
@Target(FIELD)
@Repeatable(SpelFuture.List.class)
...
public @interface SpelFuture {
     ...
     * 校验失败时的错误消息
     */
    String message() default "{com.kuma.boot.web.validation.spel.validator.constraint.Future.message}";
