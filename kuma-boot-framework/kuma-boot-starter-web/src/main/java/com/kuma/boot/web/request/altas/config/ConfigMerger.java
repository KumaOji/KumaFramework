...
public class ConfigMerger implements BeanFactoryPostProcessor {
    ...
    private com.kuma.boot.web.request.altas.config.AnnotationConfigValidator configValidator;

    @Autowired(required = false)
    private com.kuma.boot.web.request.altas.config.ConfigConflictDetector conflictDetector;
    ...
    private LogConfigProperties getAnnotationConfig(ConfigurableListableBeanFactory beanFactory) {
        try {
            if (beanFactory.containsBean(ANNOTATION_CONFIG_PROCESSOR_BEAN_NAME)) {
                com.kuma.boot.web.request.altas.config.AtlasLogAnnotationConfigBeanPostProcessor processor = beanFactory.getBean(
                        ANNOTATION_CONFIG_PROCESSOR_BEAN_NAME, com.kuma.boot.web.request.altas.config.AtlasLogAnnotationConfigBeanPostProcessor.class);
     ...
     * 合并配置（注解优先）
     */
    private LogConfigProperties mergeConfigs(
    ...
    private void mergeHttpLogConfig( LogConfigProperties merged,
        ...
        if (annotationHttpLog != null || propertiesHttpLog != null) {
            ...
            mergedHttpLog.setLogFullParameters(resolveValue(annotationLogFullParams, propertiesLogFullParams, Boolean.TRUE, "httpLogUtils.logFullParameters"));
            ...
            mergedHttpLog.setUrlFormat(resolveValue(
                    ...
                    "{uri}{queryString}", "httpLogUtils.urlFormat"));
            ...
            mergedHttpLog.setIncludeQueryString(resolveValue(annotationIncludeQuery, propertiesIncludeQuery, Boolean.TRUE, "httpLogUtils.includeQueryString"));
            ...
            mergedHttpLog.setIncludeHeaders(resolveValue(annotationIncludeHeaders, propertiesIncludeHeaders, Boolean.FALSE, "httpLogUtils.includeHeaders"));
