...
final class Util {
    ...
    public static Optional<com.kuma.boot.web.httpexchange.HttpExchangeProperties.Channel> findMatchedConfig(
            Class<?> clz, com.kuma.boot.web.httpexchange.HttpExchangeProperties properties) {
        // find from classes first
        Optional<com.kuma.boot.web.httpexchange.HttpExchangeProperties.Channel> found = properties.getChannels().stream()
    ...
    private static boolean match(Class<?> clz, com.kuma.boot.web.httpexchange.HttpExchangeProperties.Channel client) {
    ...
    public static com.kuma.boot.web.httpexchange.HttpExchangeProperties getProperties(Environment environment) {
        com.kuma.boot.web.httpexchange.HttpExchangeProperties properties = Binder.get(environment)
                .bind(com.kuma.boot.web.httpexchange.HttpExchangeProperties.PREFIX, com.kuma.boot.web.httpexchange.HttpExchangeProperties.class)
                .orElseGet(com.kuma.boot.web.httpexchange.HttpExchangeProperties::new);
