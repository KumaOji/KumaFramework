...
public final class HttpExchangeUtil {
     ...
     *
     * <p> NOTE: The second parameter {@code environment} is used to build {@link com.kuma.boot.web.httpexchange.HttpExchangeProperties} if it can't be found in the bean factory (early stage),
    ...
    public static void registerHttpExchangeBean(
        ...
        AbstractBeanDefinition beanDefinition = BeanDefinitionBuilder.genericBeanDefinition(
                        clz, () -> new com.kuma.boot.web.httpexchange.ExchangeClientCreator(beanFactory, clz).create())
                .getBeanDefinition();
    ...
    private static com.kuma.boot.web.httpexchange.HttpExchangeProperties.Refresh getRefresh(Environment environment) {
        return Binder.get(environment)
                .bind(com.kuma.boot.web.httpexchange.HttpExchangeProperties.Refresh.PREFIX, com.kuma.boot.web.httpexchange.HttpExchangeProperties.Refresh.class)
                .orElseGet(com.kuma.boot.web.httpexchange.HttpExchangeProperties.Refresh::new);
    }
}
