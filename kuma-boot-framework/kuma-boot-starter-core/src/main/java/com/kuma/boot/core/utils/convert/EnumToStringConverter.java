...
package com.kuma.boot.core.utils.convert;
...
public class EnumToStringConverter implements ConditionalGenericConverter {
    ...
    public Object convert(
        ...
        AccessibleObject accessibleObject =
                CollectionUtils.computeIfAbsent(
                        ENUM_CACHE_MAP, sourceClazz, EnumToStringConverter::getAnnotation);
    ...
    private static Object invoke(
            Class<?> clazz, AccessibleObject accessibleObject, Object source, Class<?> targetClazz)
