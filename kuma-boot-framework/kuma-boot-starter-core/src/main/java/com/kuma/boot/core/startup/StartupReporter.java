...
public class StartupReporter {
    ...
    public static final String SPRING_CONTEXT_BEANDEF_REGISTRY_POST_PROCESSOR =
    ...
    public static final Collection<String> SPRING_BEAN_INSTANTIATE_TYPES =
            Set.of(SPRING_BEANS_INSTANTIATE, SPRING_BEANS_SMART_INSTANTIATE);

    public static final Collection<String> SPRING_CONTEXT_POST_PROCESSOR_TYPES =
            Set.of(SPRING_CONTEXT_BEANDEF_REGISTRY_POST_PROCESSOR, SPRING_CONTEXT_BEAN_FACTORY_POST_PROCESSOR);
    ...
    public StartupReporter() {
        ...
        this.startupStaticsModel.setApplicationBootTime(
    ...
    public void applicationBootFinish() {
        startupStaticsModel.setApplicationBootElapsedTime(
    ...
    public com.kuma.boot.core.startup.BaseStat getStageNyName(String stageName ) {
        return startupStaticsModel.getStageStats().stream()
                ...
                .filter(commonStartupStat -> {
                    return commonStartupStat.getName().equals(stageName);
                })
                .findFirst()
                .orElse(null);
    }
    ...
    /**
     * Return the {@link StartupStaticsModel startupStaticsModel} as a snapshot of currently buffered steps.
     * <p>
     * This will not remove details from the model, see {@link #getStartupStaticsModel()} for its counterpart.
     *
     ...
     * <p>
     * This removes steps from the buffer, see {@link #getStartupStaticsModel()} for its read-only counterpart.
     *
        ...
        if (applicationStartup instanceof BufferingApplicationStartup bufferingApplicationStartup) {
            ...
            timelineEvents.forEach(timelineEvent -> {
                ...
                if (parentBeanStat != null) {
                    ...
                    parentBeanStat.setRealRefreshElapsedTime(
                            parentBeanStat.getRealRefreshElapsedTime() - beanStat.getCost());
