...
public final class PropertyDescriptorUtils {
     ...
     * @return 属性写方法
     */
    public static Method getWriteMethod(final Class beanClass, final String propertyName) {
        PropertyDescriptor propertyDescriptor = getPropertyDescriptor(beanClass, propertyName);
     ...
     * @return 是否设置成功
     */
    public static boolean setPropertyValue(
            Object bean, PropertyDescriptor descriptor, Object value) {
        try {
    ...
    public static boolean setPropertyValue(Object bean, String descriptorName, Object value) {
        PropertyDescriptor propertyDescriptor =
                getPropertyDescriptor(bean.getClass(), descriptorName);
