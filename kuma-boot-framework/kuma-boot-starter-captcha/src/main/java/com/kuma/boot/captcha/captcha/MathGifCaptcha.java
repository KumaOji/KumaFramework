...
extends AbstractMathCaptcha {
    ...
    public boolean out(OutputStream os) {
        ...
        try {
            ...
            for (i = 0; i < this.len; ++i) {
                fontcolor[i] = new Color(20 + MathGifCaptcha.num(110), 20 + MathGifCaptcha.num(110), 20 + MathGifCaptcha.num(110));
            }
            for (i = 0; i < this.len; ++i) {
    ...
    private BufferedImage graphicsImage(Color[] fontcolor, char[] strs, int flag) {
        ...
        for (int i = 0; i < strs.length; ++i) {
            ...
            int x = i * w + sp + MathGifCaptcha.num(3);
            int y = h - MathGifCaptcha.num(3, 6);
            if (x < 8) {
                x = 8;
            }
            ...
            g2d.setFont(this.font.deriveFont(MathGifCaptcha.num(2) == 0 ? 0 : 2));
