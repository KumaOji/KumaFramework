...
import static com.kuma.boot.dingtalk.enums.ExceptionEnum.DINGERDEFINITION_ERROR;
...
public class DingerDefinitionGeneratorFactory {
    ...
    public static DingerDefinitionGenerator get(String key) {
        ...
        if (dingTalkDefinitionGenerator == null) {
            LogUtils.debug("key={}, dingTalkDefinitionGeneratorMap={}.", key, dingTalkDefinitionGeneratorMap.keySet());
