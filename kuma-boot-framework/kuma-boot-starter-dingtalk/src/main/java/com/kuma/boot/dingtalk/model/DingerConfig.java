...
public class DingerConfig {
    ...
    private DingerConfig(
            DingerType dingerType, String tokenId, String secret, String decryptKey, boolean asyncExecute) {
     ...
     * Dinger机器人配置实例
     *
     * @param dingerType Dinger机器人类型, {@link DingerType}, MultiDinger中无需指定
     * @param tokenId 机器人tokenID
     * @return 机器人配置实例
     */
     ...
     * @param tokenId 机器人tokenID
     * @param secret 机器人签名秘钥
     * @param decryptKey Dinger组件内部解密秘钥
     * @return 机器人配置实例
     */
     ...
     * @return 机器人配置实例
     */
    public static DingerConfig instance(
            DingerType dingerType, String tokenId, String secret, String decryptKey, boolean asyncExecute) {
    ...
    public String toString() {
        return "DingerConfig(dingerType="
                + this.dingerType
                + ", tokenId="
                + this.tokenId
                + ", decryptKey="
