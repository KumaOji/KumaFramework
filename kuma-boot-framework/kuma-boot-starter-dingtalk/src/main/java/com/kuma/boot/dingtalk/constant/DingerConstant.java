...
package com.kuma.boot.dingtalk.constant;
...
public interface DingerConstant {
    ...
    /** 全垒打执行人 bean name */
    String DINGER_EXECUTOR = "dingtalkExecutor";
    /** 全垒打其他模板 自定义restTemplate名称 */
    ...
    /** 全垒打道具前缀 */
    String DINGER_PROP_PREFIX = "kuma.boot.dingtalk";
    /** 全垒打属性前缀 */
