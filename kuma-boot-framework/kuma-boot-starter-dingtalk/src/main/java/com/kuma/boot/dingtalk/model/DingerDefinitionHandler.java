...
import static com.kuma.boot.dingtalk.enums.ExceptionEnum.DINGERDEFINITIONTYPE_ERROR;
...
public class DingerDefinitionHandler {
    ...
    protected static DingerDefinition dingerTextHandler(
            DingerType dingerType, DingerDefinitionGeneratorContext<DingerText> context) {
    ...
    protected static DingerDefinition dingerMarkdownHandler(
            DingerType dingerType, DingerDefinitionGeneratorContext<DingerMarkdown> context) {
        String keyName = context.getKeyName();
    ...
    protected static DingerDefinition dingerImageTextHandler(
            DingerType dingerType, DingerDefinitionGeneratorContext<DingerImageText> context) {
        String keyName = context.getKeyName();
    ...
    protected static DingerDefinition dingerLinkHandler(
            DingerType dingerType, DingerDefinitionGeneratorContext<DingerLink> context) {
        String keyName = context.getKeyName();
    ...
    protected static DingerDefinition xmlHandler(
            DingerDefinitionType dingerDefinitionType, DingerDefinitionGeneratorContext<MessageTag> context) {
