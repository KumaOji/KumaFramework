 ...
 * Entity 对象封装操作类
 *
 * <p>相比 QueryWrapper 的增强如下： 1，new QueryWrapper(T entity)时， 对entity 中的string字段 %和_ 符号进行转义，便于模糊查询
 ...
 * 符号进行转义，便于模糊查询 5，增加 leFooter 方法， 将日期参数值，强制转换成当天 23：59：59 6，增加 geHeader 方法， 将日期参数值，强制转换成当天 00：00：00
 *
 * @param <T> T
 * @author kuma
 * @version 2021.9
...
public class QueryWrap<T> extends AbstractWrapper<T, String, QueryWrap<T>>
    ...
    public com.kuma.boot.data.mybatis.mybatisplus.query.conditions.query.LbqWrapper<T> lambda() {
        return new com.kuma.boot.data.mybatis.mybatisplus.query.conditions.query.LbqWrapper<>(
                getEntity(),
                getEntityClass(),
                sqlSelect,
                paramNameSeq,
