...
public class DuccMonitorUtil {
    ...
    public static void start(String appName, String uri, String moniterKey) {
        try {
            ...
            // ConfiguratorManager.getInstance() ;
            ...
            //
            //            //获取配置 (获取指定配置源下指定配置)
            //            Property property = configuratorManager.getProperty(resourceName,
            // moniterKey);
            //            log.info("sql analysis ducc moniterKey:" + property.getString());
            //            duccConfig = property.getString();
            //
            //            //添加监听器，配置项维度的监听器
            //            configuratorManager.addListener(new
            // PropertyListener.CustomPropertyListener(moniterKey) {
            //                @Override
