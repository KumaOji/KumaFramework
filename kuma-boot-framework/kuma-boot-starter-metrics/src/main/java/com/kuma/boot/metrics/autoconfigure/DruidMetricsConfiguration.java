...
import com.kuma.boot.metrics.druid.DruidCollector;
   ...
   public void bindMetricsRegistryToDruidDataSources(Collection<DataSource> dataSources) throws SQLException {
      ...
      for(DataSource dataSource : dataSources) {
         if (dataSource instanceof DruidDataSource) {
            DruidDataSource druidDataSource = (DruidDataSource)dataSource.unwrap(DruidDataSource.class);
      ...
      DruidCollector druidCollector = new DruidCollector(druidDataSources, this.registry);
