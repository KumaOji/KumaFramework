...
@Component
public class NestedProperty implements PropertyStratgy {
   ...
   public Property handleProperty(EsField annotation, Field field, ElasticUtil elasticUtil) {
      return Property.of((p) -> p.nested((n) -> {
            n.properties(elasticUtil.handleProperties(field.getType().getDeclaredFields()));
            return n;
         }));
   }
}
