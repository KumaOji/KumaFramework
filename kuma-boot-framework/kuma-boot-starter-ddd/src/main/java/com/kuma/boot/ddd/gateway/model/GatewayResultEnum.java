...
public enum GatewayResultEnum {
   ...
   private GatewayResultEnum(String code, String desc) {
      this.code = code;
      this.desc = desc;
   }
   ...
   // $FF: synthetic method
   private static GatewayResultEnum[] $values() {
      return new GatewayResultEnum[]{GATEWAY_ERROR, AUTH_C0DE_ERROR, AUTH_303001, AUTH_303002, AUTH_303003, AUTH_303004, AUTH_303005, AUTH_303006, AUTH_303007};
   }
}
