...
public class RingBuffer {
   ...
   public long take() {
      ...
      if (currentTail - nextCursor < (long)this.paddingThreshold) {
         LogUtils.info("[uid-gen] Reach the padding threshold:{}. tail:{}, cursor:{}, rest:{}", new Object[]{this.paddingThreshold, currentTail, nextCursor, currentTail - nextCursor});
   ...
   protected void discardPutBuffer(RingBuffer ringBuffer, long uid) {
      LogUtils.warn("[uid-gen] Rejected putting buffer for uid:{}. {}", new Object[]{uid, ringBuffer});
   }

   protected void exceptionRejectedTakeBuffer(RingBuffer ringBuffer) {
      LogUtils.warn("[uid-gen] Rejected take buffer. {}", new Object[]{ringBuffer});
