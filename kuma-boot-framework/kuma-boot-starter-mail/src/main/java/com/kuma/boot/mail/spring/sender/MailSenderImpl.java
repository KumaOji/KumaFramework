...
public class MailSenderImpl implements com.kuma.boot.mail.spring.sender.MailSender {
   ...
   public MailSenderImpl(
           JavaMailSender mailSender, ApplicationEventPublisher eventPublisher, MailProperties mailProperties) {
   ...
   private void sendMimeMail(MailDetails mailDetails) throws MessagingException {
      ...
      String from = StringUtils.hasText(mailDetails.getFrom()) ? mailDetails.getFrom() : mailProperties.getUsername();
