...
public class MailUtils {
   ...
   public MailAccount getMailAccount(String from, String user, String pass) {
      ACCOUNT.setFrom(defaultIfBlank(from, ACCOUNT.getFrom()));
      ACCOUNT.setUser(defaultIfBlank(user, ACCOUNT.getUser()));
      ACCOUNT.setPass(
              defaultIfBlank(pass, String.valueOf(ACCOUNT.getPass())));
      return ACCOUNT;
   }
    ...
    */
   public String send(
           String to, String cc, String bcc, String subject, String content, boolean isHtml, File... files) {
    ...
    */
   public String send(
           MailAccount mailAccount, String to, String subject, String content, boolean isHtml, File... files) {
   ...
   public String sendHtml(
           String to, String subject, String content, Map<String, InputStream> imageMap, File... files) {
    ...
    */
   public String sendHtml(
           Collection<String> tos, String subject, String content, Map<String, InputStream> imageMap, File... files) {
