"""ChannelManager — consumes inbound messages and dispatches them to the KumaAgent agent via LangGraph Server."""
...
class ChannelManager:
    """Core dispatcher that bridges IM channels to the KumaAgent agent.
    ...
    async def _handle_chat(self, msg: InboundMessage, extra_context: dict[str, Any] | None = None) -> None:
        ...
        # Look up existing KumaAgent thread.
