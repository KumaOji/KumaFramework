...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: kuma_agent-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. kuma_agent.sandbox.local:LocalSandboxProvider)",
    )
