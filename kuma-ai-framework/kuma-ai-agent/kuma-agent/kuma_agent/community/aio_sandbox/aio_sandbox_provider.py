...
from kuma_agent.config.paths import VIRTUAL_PATH_PREFIX, Paths, get_paths
from kuma_agent.sandbox.sandbox import Sandbox
from kuma_agent.sandbox.sandbox_provider import SandboxProvider
...
DEFAULT_PORT = 8080
DEFAULT_CONTAINER_PREFIX = "kuma_agent-sandbox"
...
class AioSandboxProvider(SandboxProvider):
    ...
    Configuration options in config.yaml under sandbox:
        use: kuma_agent.community.aio_sandbox:AioSandboxProvider
        image: <container image>
        port: 8080                      # Base port for local containers
        container_prefix: kuma_agent-sandbox
