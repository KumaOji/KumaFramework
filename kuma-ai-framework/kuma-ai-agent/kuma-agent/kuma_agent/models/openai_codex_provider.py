...
from kuma_agent.models.credential_loader import CodexCliCredential, load_codex_cli_credential
...
class CodexChatModel(BaseChatModel):
    ...
    Config example:
        - name: gpt-5.4
          use: kuma_agent.models.openai_codex_provider:CodexChatModel
          model: gpt-5.4
