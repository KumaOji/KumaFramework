...
Usage::
    ...
    from kuma_agent.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from kuma_agent.config.checkpointer_config import CheckpointerConfig
from kuma_agent.config.paths import resolve_path
...
def get_checkpointer() -> Checkpointer:
    ...
    from kuma_agent.config.app_config import _app_config
    from kuma_agent.config.checkpointer_config import get_checkpointer_config
