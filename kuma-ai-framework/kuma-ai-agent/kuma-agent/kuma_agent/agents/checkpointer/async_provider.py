...
Usage (e.g. FastAPI lifespan)::
    ...
    from kuma_agent.agents.checkpointer.async_provider import make_checkpointer

    async with make_checkpointer() as checkpointer:
        app.state.checkpointer = checkpointer  # InMemorySaver if not configured

For sync usage see :mod:`kuma_agent.agents.checkpointer.provider`.
"""
...
from kuma_agent.agents.checkpointer.provider import (
