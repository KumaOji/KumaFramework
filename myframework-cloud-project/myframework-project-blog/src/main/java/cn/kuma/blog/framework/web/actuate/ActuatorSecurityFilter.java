...
package cn.kuma.blog.framework.web.actuate;

import cn.kuma.blog.common.core.constant.HeaderConstants;
...
public class ActuatorSecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (verifySign(reqSecretId, sign, reqTime)) {
            ...
            response.getWriter().write(JsonUtil.toJsonOrNull(apiResult));
        }
    }
