...
package cn.kuma.blog.framework.web.pageable;

import cn.kuma.blog.common.core.constant.Symbol;
...
public abstract class PageParamArgumentResolverSupport {
    ...
    protected void fillValidSort(String field, String order, List<PageParam.Sort> sorts) {
        if (validFieldName(field)) {
            ...
            // 正序/倒序
            sort.setField(cn.kuma.blog.common.util.StringUtils.toUnderlineCase(field));
            sorts.add(sort);
        }
    }
