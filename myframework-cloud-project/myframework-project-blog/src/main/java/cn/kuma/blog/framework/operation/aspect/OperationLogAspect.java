...
package cn.kuma.blog.framework.operation.aspect;

import cn.kuma.blog.framework.operation.annotation.OperationLogging;
import cn.kuma.blog.framework.operation.handler.OperationLogHandler;
...
public class OperationLogAspect<T> {
    ...
    @Around("execution(@(@cn.kuma.blog.framework.operation.annotation.OperationLogging *) * *(..)) "
            + "|| @annotation(cn.kuma.blog.framework.operation.annotation.OperationLogging)")
