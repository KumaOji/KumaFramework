...
package cn.kuma.blog.framework.mybatisplus.toolkit;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.core.metadata.OrderItem;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import cn.kuma.blog.common.model.domain.PageParam;
import cn.kuma.blog.common.model.domain.PageQuery;
...
public final class PageUtil {
     ...
     * @return IPage<V>
     */
    public static <V> IPage<V> prodPage(PageQuery pageQuery) {
        Page<V> page = new Page<>(pageQuery.getOffset(), pageQuery.getLimit());
        List<PageParam.Sort> sorts = pageQuery.getSorts();
        for (PageParam.Sort sort : sorts) {
            OrderItem orderItem = sort.isAsc() ? OrderItem.asc(sort.getField()) : OrderItem.desc(sort.getField());
            page.addOrder(orderItem);
        }
