...
public final class Assert {
    ...
    public static void isTrue(boolean expression, String errorMsgTemplate, Object... params)
        ...
        isTrue(expression, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
     ...
     * 并使用指定的函数获取错误信息返回 <pre class="code">
     *  Assert.isFalse(i &gt; 0, ()-&gt;{
    ...
    public static void isFalse(boolean expression, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        isFalse(expression, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 断言对象是否为{@code null} ，如果不为{@code null} 抛出指定类型异常 并使用指定的函数获取错误信息返回 <pre class="code">
     * Assert.isNull(value, ()-&gt;{
     *      // to query relation message
     *      return new IllegalArgumentException("relation message to return");
     *  });
    ...
    public static void isNull(Object object, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        isNull(object, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 断言对象是否不为{@code null} ，如果为{@code null} 抛出指定类型异常 并使用指定的函数获取错误信息返回 <pre class="code">
    ...
    /**
     * 断言对象是否不为{@code null} ，如果为{@code null} 抛出{@link IllegalArgumentException} 异常 Assert
    ...
    public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notNull(object, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 检查给定字符串是否为空，为空抛出自定义异常，并使用指定的函数获取错误信息返回。 <pre class="code">
    ...
    public static <T extends CharSequence> T notEmpty(T text, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        return notEmpty(text, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 检查给定字符串是否为空白（null、空串或只包含空白符），为空抛出自定义异常。 并使用指定的函数获取错误信息返回 <pre class="code">
    ...
    public static <T extends CharSequence, X extends Throwable> T notBlank(T text, Supplier<X> errorMsgSupplier)
            throws X {
        if (text == null || text.length() == 0 || !StringUtils.containsText(text)) {
    ...
    public static <T extends CharSequence> T notBlank(T text, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        return notBlank(text, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 断言给定字符串是否不被另一个字符串包含（即是否为子串） 并使用指定的函数获取错误信息返回 <pre class="code">
    ...
    public static <T extends CharSequence, X extends Throwable> T notContain(CharSequence textToSearch, T substring,
        ...
        if (null != textToSearch && null != substring && textToSearch.toString().contains(substring)) {
            throw errorSupplier.get();
        }
        return substring;
    }
     ...
     * @param params 参数列表
     * @return 被检查的数组
     * @throws IllegalArgumentException if the object array is {@code null} or has no
     * elements
     */
    public static <T> T[] notEmpty(T[] array, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        return notEmpty(array, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    public static <T, X extends Throwable> T[] noNullElements(T[] array, Supplier<X> errorSupplier) throws X {
        if (null == array) {
            ...
            for (T element : array) {
                if (null == element || element.equals(null)) {
                    throw errorSupplier.get();
                }
            }
        }
    ...
    public static <T> T[] noNullElements(T[] array, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        return noNullElements(array, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 断言给定集合非空 并使用指定的函数获取错误信息返回 <pre class="code">
    ...
    public static <E, T extends Iterable<E>, X extends Throwable> T notEmpty(T collection, Supplier<X> errorSupplier)
            throws X {
        if (null == collection || null == collection.iterator() || !collection.iterator().hasNext()) {
            throw errorSupplier.get();
        }
        return collection;
    }
    ...
    public static <E, T extends Iterable<E>> T notEmpty(T collection, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        return notEmpty(collection, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 断言给定Map非空 并使用指定的函数获取错误信息返回 <pre class="code">
     * Assert.notEmpty(map, ()-&gt;{
     *      // to query relation message
     *      return new IllegalArgumentException("relation message to return");
     *  });
    ...
    public static <K, V, T extends Map<K, V>> T notEmpty(T map, String errorMsgTemplate, Object... params)
            throws IllegalArgumentException {
        return notEmpty(map, () -> new IllegalArgumentException(format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 断言两个对象是否不相等,如果两个对象相等 抛出IllegalArgumentException 异常 <pre class="code">
    ...
    /**
     * 断言两个对象是否相等,如果两个对象不相等 抛出IllegalArgumentException 异常 <pre class="code">
