 ...
 */
@ConditionalOnClass(RedisMappingContext.class)
//@EnableRedisDocumentRepositories(basePackages = {"com.kuma.cloud.*.biz.redisSearch","com.kuma.cloud.*.infrastructure.redisSearch.**"})
@AutoConfiguration
