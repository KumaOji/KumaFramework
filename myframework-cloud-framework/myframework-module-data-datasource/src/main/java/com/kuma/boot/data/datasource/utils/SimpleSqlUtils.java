...
public class SimpleSqlUtils implements SqlUtils {
     ...
     * 构建预处理
     */
    protected CommandPrepare buildPrepare(
            String sql, Object args, boolean returnKeys, boolean isStream) throws SQLException {
    ...
    @Override
    public Iterator<Map<String, Object>> selectRowStream(String sql, int fetchSize, Object... args)
            throws SQLException {
