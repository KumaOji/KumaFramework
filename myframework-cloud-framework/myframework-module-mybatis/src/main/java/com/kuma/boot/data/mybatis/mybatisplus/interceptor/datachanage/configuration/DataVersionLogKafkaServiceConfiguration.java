...
import com.kuma.boot.data.mybatis.mybatisplus.interceptor.datachanage.service.impl.DataVersionLogKafkaService;
...
@ConditionalOnProperty(
        ...
        name = "enabled",
        havingValue = "true")
public class DataVersionLogKafkaServiceConfiguration implements InitializingBean {

    @Autowired private MybatisPlusInterceptorProperties mybatisPlusInterceptorProperties;

    @Override
    public void afterPropertiesSet() throws Exception {
        LogUtils.started(DataVersionLogKafkaServiceConfiguration.class, StarterNameConstants.LOGGER_STARTER);
    }

    @Bean
    public DataVersionLogService dataVersionLogKafkaService(
                                ...
                                e.name()
                                        .equals(
                                                MybatisPlusInterceptorProperties.DataChange
                                                        .StoreType.KAFKA
                                                        .name()))) {
            return new DataVersionLogKafkaService(kafkaTemplate);
        }
        return null;
    }
}
