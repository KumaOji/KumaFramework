...
public class DataPermissionAnnotationAdvisor extends DefaultPointcutAdvisor {
    ...
    public DataPermissionAnnotationAdvisor() {
        // 自定义通知
        this.advice = new com.kuma.boot.data.mybatis.mybatisplus.interceptor.datascope.dataPermission.aop.DataPermissionAdvice();
        // 自定义切入点
        this.pointcut = com.kuma.boot.data.mybatis.mybatisplus.interceptor.datascope.dataPermission.aop.DataPermissionPointcut.of();
    }
    ...
    public DataPermissionAnnotationAdvisor(
            Pointcut pointcut, Advice advice, Advice advice1, Pointcut pointcut1) {
