...
package com.kuma.boot.data.mybatis.mybatisplus.interceptor.datascopeother.mybatis;

import com.baomidou.mybatisplus.extension.plugins.handler.DataPermissionHandler;
import com.kuma.boot.data.mybatis.mybatisplus.interceptor.datascopeother.aspect.DataScopeAspect;
...
import com.kuma.boot.data.mybatis.mybatisplus.interceptor.datascopeother.enums.SpliceTypeEnum;
...
public class DataScopeHandler implements DataPermissionHandler {
    ...
    public Expression getSqlSegment(Expression where, String mappedStatementId) {
        ...
        String sql =
                "".equals(dto.getTableAlias()) || dto.getTableAlias() == null
                        ? dto.getColumnName()
                        : dto.getTableAlias() + "." + dto.getColumnName();
        ...
        if (dto.getProvideType().equals(ProvideTypeEnum.METHOD.getCode())) {
            ...
            // ItemsList itemsList =
            //         new
            // ExpressionList(idList.stream().map(LongValue::new).collect(Collectors.toList()));
            ...
            //
            //     if (dto.getSpliceType().equals(SpliceTypeEnum.OR.toString())) {
            //         return where == null ? notExpression : new OrExpression(where,
            // notExpression);
            //     } else if (dto.getSpliceType().equals(SpliceTypeEnum.AND.toString())) {
            //         return where == null ? notExpression : new AndExpression(where,
            // notExpression);
            //     } else {
            //         throw new RuntimeException("错误的拼接类型：" + dto.getSpliceType());
            //     }
            ...
            if (dto.getExpression().equals(ExpressionEnum.EQ.toString())) {
                ...
                if (dto.getSpliceType().equals(SpliceTypeEnum.OR.toString())) {
                    ...
                    return where == null
                            ? likeExpression
                            : new AndExpression(where, likeExpression);
                } else {
                    throw new RuntimeException("错误的拼接类型：" + dto.getSpliceType());
                }
                ...
                if (dto.getSpliceType().equals(SpliceTypeEnum.OR.toString())) {
                    return where == null
                            ? greaterThanEquals
                            : new OrExpression(where, greaterThanEquals);
                } else if (dto.getSpliceType().equals(SpliceTypeEnum.AND.toString())) {
                    return where == null
                            ? greaterThanEquals
                            : new AndExpression(where, greaterThanEquals);
                } else {
                    throw new RuntimeException("错误的拼接类型：" + dto.getSpliceType());
                }
                ...
                if (dto.getSpliceType().equals(SpliceTypeEnum.OR.toString())) {
                    return where == null
                            ? minorThanEquals
                            : new OrExpression(where, minorThanEquals);
                } else if (dto.getSpliceType().equals(SpliceTypeEnum.AND.toString())) {
                    return where == null
                            ? minorThanEquals
                    ...
                    || dto.getExpression().equals(ExpressionEnum.NOT_NULL.toString())) {
                Column column = new Column(dto.getColumnName());
                ...
                if (dto.getSpliceType().equals(SpliceTypeEnum.OR.toString())) {
                    return where == null
                            ? isNullExpression
                            : new OrExpression(where, isNullExpression);
                } else if (dto.getSpliceType().equals(SpliceTypeEnum.AND.toString())) {
                    return where == null
                            ? isNullExpression
                            : new AndExpression(where, isNullExpression);
                } else {
                    throw new RuntimeException("错误的拼接类型：" + dto.getSpliceType());
                }
