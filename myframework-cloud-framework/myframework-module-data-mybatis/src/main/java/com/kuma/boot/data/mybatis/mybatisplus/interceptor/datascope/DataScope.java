...
public class DataScope extends HashMap {
    ...
    public DataScope(
            int initialCapacity, float loadFactor, String scopeFiledName, List<Integer> deptIds) {
        super(initialCapacity, loadFactor);
        this.scopeFiledName = scopeFiledName;
        this.deptIds = deptIds;
    }

    public DataScope(int initialCapacity, String scopeFiledName, List<Integer> deptIds) {
