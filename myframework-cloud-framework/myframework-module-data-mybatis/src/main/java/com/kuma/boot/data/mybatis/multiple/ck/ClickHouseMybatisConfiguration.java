...
package com.kuma.boot.data.mybatis.multiple.ck;
...
/**
 * ClickHouseMybatisConfiguration
 *
 * @author kuma
 * @version 2026.01
...
@MapperScan(
        basePackages = "com.kuma.cloud.*.clickhouse.mapper",
...
public class ClickHouseMybatisConfiguration {
    ...
    private static final String TYPE_ALIASES_PACKAGE = "com.kuma.boot.data.analysis.clickhouse.*";

    @Bean("clickHouseSqlSessionFactory")
    public SqlSessionFactory clickHouseSqlSessionFactory(
            @Qualifier("clickHouseDruidDataSource") DataSource dataSource ) throws Exception {
