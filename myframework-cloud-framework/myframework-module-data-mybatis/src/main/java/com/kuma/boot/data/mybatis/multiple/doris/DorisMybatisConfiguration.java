...
package com.kuma.boot.data.mybatis.multiple.doris;
...
@MapperScan(
        basePackages = "com.kuma.cloud.*.doris.mapper",
...
public class DorisMybatisConfiguration {
    ...
    private static final String TYPE_ALIASES_PACKAGE = "com.kuma.boot.data.analysis.doris.*";
