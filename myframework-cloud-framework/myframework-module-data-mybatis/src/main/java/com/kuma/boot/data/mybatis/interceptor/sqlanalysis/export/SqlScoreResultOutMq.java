 ...
 **/
public class SqlScoreResultOutMq implements com.kuma.boot.data.mybatis.interceptor.sqlanalysis.export.SqlScoreResultOutService {
    ...
    public void outResult(SqlScoreResult sqlScoreResult) {
        ...
        if (sqlScoreResult.getNeedWarn() != null && sqlScoreResult.getNeedWarn()) {
            ...
            // todo 待替换为开源组件
            logger.error(
                    "sql analysis result sqlId:{}, score:{}",
