...
package com.kuma.boot.data.mybatis.mybatisplus.query.conditions;

import static com.kuma.boot.common.constant.StrPoolConstants.PERCENT;
import static com.kuma.boot.common.constant.StrPoolConstants.UNDERSCORE;

import cn.hutool.core.util.ReflectUtil;
import com.baomidou.mybatisplus.annotation.TableField;
import com.kuma.boot.common.utils.date.DateUtils;
import com.kuma.boot.data.mybatis.mybatisplus.StrHelper;
import com.kuma.boot.data.mybatis.mybatisplus.query.conditions.query.LbqWrapper;
import com.kuma.boot.data.mybatis.mybatisplus.query.conditions.query.QueryWrap;
import com.kuma.boot.data.mybatis.mybatisplus.query.conditions.update.LbuWrapper;
...
public final class Wraps {
    ...
    public static <T> LbqWrapper<T> lbq(
            Class<T> entityClass, Map<String, Object> extra, Class<T> modelClazz) {
        ...
        if (MapUtil.isNotEmpty(extra)) {
            ...
            for (Map.Entry<String, Object> field : extra.entrySet()) {
                ...
                if (key.endsWith("_st")) {
                    ...
                    wrapper.ge(
                            getDbField(beanField, modelClazz),
