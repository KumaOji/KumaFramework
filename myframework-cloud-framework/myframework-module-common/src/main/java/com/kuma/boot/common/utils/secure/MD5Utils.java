...
public class MD5Utils {
    ...
    public static String encrypt(String text) {
        ...
        /** 首位是0会被忽略 */
        /**
         * try { MessageDigest messageDigest = MessageDigest.getInstance(MD5); byte[]
         * dataBytes = text.getBytes(StandardCharsets.UTF_8);
         * messageDigest.update(dataBytes); return new BigInteger(1,
         * messageDigest.digest()).toString(16); } catch (Exception e) {
