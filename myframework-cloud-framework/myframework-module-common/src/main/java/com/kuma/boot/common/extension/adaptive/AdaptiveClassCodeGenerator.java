...
public class AdaptiveClassCodeGenerator {
    ...
    private static final String CODE_CLASS_DECLARATION =
    ...
    private static final String CODE_UNSUPPORTED =
            "throw new UnsupportedOperationException(\"The method %s of interface %s is not"
                    + " adaptive method!\");\n";
    ...
    private static final String CODE_EXT_NAME_NULL_CHECK =
            "if(extName == null) throw new IllegalStateException(\"Failed to get extension (%s)"
    ...
    private String generateGetUrlNullCheck(int index, Class<?> type, String method) {
        return String.format(
                ...
                index, type.getName())
                + String.format(
                "if (arg%d.%s() == null) throw new IllegalArgumentException(\"%s argument"
                        + " %s() == null\");\n",
