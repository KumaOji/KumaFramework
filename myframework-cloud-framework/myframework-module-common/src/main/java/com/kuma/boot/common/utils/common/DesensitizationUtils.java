...
public final class DesensitizationUtils {
    ...
    public static String middle(@Nullable final String sensitiveStr) {
        ...
        int length = sensitiveStr.length();
        if (length < 3) {
            return StringUtils.leftPad(StrPoolConstants.EMPTY, length, CharPool.STAR);
        }
    ...
    public static String sensitive(
            @Nullable String str, int fromIndex, int lastSize, char padChar) {
    ...
    @Nullable
    public static String sensitive(
            @Nullable String str, int fromIndex, int lastSize, char padChar, int padSize) {
        if (str == null) {
            return null;
        }
