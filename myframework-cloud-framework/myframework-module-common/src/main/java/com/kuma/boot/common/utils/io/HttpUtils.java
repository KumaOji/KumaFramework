...
public final class HttpUtils {
    ...
    public static String request(String requestUrl, String requestMethod) {
        return request(requestUrl, requestMethod, CommonConstants.UTF8, null);
    }
    ...
    public static String request(
            String requestUrl, String requestMethod, final Map<String, String> headerMap) {
        return request(requestUrl, requestMethod, CommonConstants.UTF8, headerMap);
    }
    ...
    public static Map<String, String> buildHeaderMap(final String filePath) {
        ...
        for (String line : stringList) {
            int index = line.indexOf(PunctuationConstants.COLON);
     ...
     */
    public static void download(final String remoteUrl, final String localUrl) {
    ...
    public static void download(
            final String remoteUrl, final String localUrl, final Map<String, String> headerMap) {
