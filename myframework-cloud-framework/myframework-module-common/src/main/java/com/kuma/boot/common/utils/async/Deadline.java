...
public class Deadline {
    ...
    /**
     * Returns the time left between the deadline and now. The result is negative if the
     * deadline has passed.
     */
    ...
    /**
     * Returns the time left between the deadline and now. If no time is left, a
    ...
    /**
     * Determines whether the deadline is in the past, i.e. whether the time left is zero
     * or negative.
     */
    ...
    /**
     * Constructs a {@link Deadline} that has now as the deadline. Use this and then
     * extend via {@link #plus(Duration)} to specify a deadline in the future.
     */
    ...
    /**
     * Constructs a Deadline that is a given duration after now, where now and all other
     * times from this deadline are defined by the given {@link Clock}.
