...
import com.kuma.boot.common.support.tuple.pair.KeyPair;
...
public class RSAUtils {
    ...
    public static String encrypt(String text, String publicKey) {
        if (org.apache.commons.lang3.StringUtils.isAnyBlank(text, publicKey)) {
            return null;
        }
        try {
            // base64编码的公钥
    ...
    public static String decrypt(String ciphertext, String privateKey) {
        if (org.apache.commons.lang3.StringUtils.isAnyBlank(ciphertext, privateKey)) {
            return null;
        }
        try {
            // 64位解码加密后的字符串
    ...
    public static String encryptToBase64(PublicKey publicKey, @Nullable String data) {
        ...
        return Base64.getEncoder()
                .encodeToString(encrypt(publicKey, data.getBytes(StandardCharsets.UTF_8)));
    }
    ...
    public static String decryptFromBase64(PrivateKey privateKey, @Nullable String base64Data) {
        ...
        return new String(
                decrypt(privateKey, Base64.getDecoder().decode(base64Data)),
     ...
     */
    @Nullable
    public static String decryptByPublicKeyFromBase64(
            PublicKey publicKey, @Nullable String base64Data) {
        if (StringUtils.isBlank(base64Data)) {
            return null;
        }
        return new String(
                decryptByPublicKey(publicKey, Base64.getDecoder().decode(base64Data)),
                StandardCharsets.UTF_8);
    }
    ...
    @Nullable
    public static String decryptByPublicKeyFromBase64(
            String base64PublicKey, @Nullable String base64Data) {
        return decryptByPublicKeyFromBase64(getPublicKey(base64PublicKey), base64Data);
    }
}
