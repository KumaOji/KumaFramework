...
public final class ReflectAnnotationUtils {
    ...
    public static void updateValue(
            final Annotation annotation, final String method, final Object value) {
        // 获取 memberValues
    ...
    /**
     * 获取对应的注解属性 map https://segmentfault.com/a/1190000011213222?utm_source=tag-newest
     * @param annotation 直接
     * @return map
     */
    @SuppressWarnings("unchecked")
     ...
     * @return 注解信息
     */
    public static Optional<Annotation> getAnnotation(
            final Annotation annotation, final Class<? extends Annotation> annotationClass) {
     ...
     * @return 结果列表
     */
    public static List<Annotation> getAnnotationRefs(
            final Class clazz, final Class<? extends Annotation> annotationClass) {
        ArgUtils.notNull(clazz, "clazz");
        ArgUtils.notNull(annotationClass, "annotationClass");
