 ...
 */
public class NullPrimitiveWrapperBooleanJsonSerializer<T> extends StdSerializer<T> {

    /** 声明为单例模式 */
    public static final NullPrimitiveWrapperBooleanJsonSerializer<Object> INSTANCE =
            new NullPrimitiveWrapperBooleanJsonSerializer<>(Object.class);
