...
public class WindowSDFrameImpl<T> extends SDFrameImpl<T> implements WindowSDFrame<T> {
    ...
    @Override
    public <F> WindowSDFrameImpl<T> overLagS(
    ...
    @Override
    public <F> WindowSDFrame<T> overLeadS(
            SetFunction<T, F> setFunction, Function<T, F> field, int n) {
    ...
    @Override
    public <F> WindowSDFrameImpl<T> overNthValueS(
            SetFunction<T, F> setFunction, Function<T, F> field, int n) {
        return returnWDF(
                this.window, super.overNthValueS(setFunction, this.window, field, n).stream());
    }

    @Override
    public <F> WindowSDFrameImpl<T> overFirstValueS(
            SetFunction<T, F> setFunction, Function<T, F> field) {
        return returnWDF(
                this.window, super.overFirstValueS(setFunction, this.window, field).stream());
    }
    ...
    @Override
    public <F> WindowSDFrameImpl<T> overLastValueS(
            SetFunction<T, F> setFunction, Function<T, F> field) {
        return returnWDF(
                this.window, super.overLastValueS(setFunction, this.window, field).stream());
    }
    ...
    @Override
    public <F> WindowSDFrameImpl<T> overSumS(
    ...
    @Override
    public <F> WindowSDFrameImpl<T> overAvgS(
            SetFunction<T, BigDecimal> setFunction, Function<T, F> field) {
    ...
    @Override
    public <F extends Comparable<? super F>> WindowSDFrameImpl<T> overMaxValueS(
            SetFunction<T, F> setFunction, Function<T, F> field) {
    ...
    @Override
    public <F extends Comparable<? super F>> WindowSDFrameImpl<T> overMinValueS(
            SetFunction<T, F> setFunction, Function<T, F> field) {
