...
public class ChineseCharUtils {
    ...
    public static String ODD_CHINESE_CHARS =
    ...
    public static String genOneChineseChars() {
        ...
        byte[] b =
                new byte[]{
                        ( Integer.valueOf(highPos) ).byteValue(), ( Integer.valueOf(lowPos) ).byteValue()
                };
