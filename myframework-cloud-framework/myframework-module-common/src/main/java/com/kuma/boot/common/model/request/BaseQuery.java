...
public record BaseQuery(
        /** 相同查询参数 */
        @Schema(description = "相同查询参数") List<EqDTO> eqQuery,
        /** 时间范围查询参数 */
        @Schema(description = "时间范围查询参数") List<DateTimeBetweenDTO> dateTimeBetweenQuery,
        /** 排序查询参数 */
        @Schema(description = "排序查询参数") List<SortDTO> sortQuery,
        /** execl查询参数 */
        @Schema(description = "execl查询参数") ExeclDTO execlQuery,
        /** 模糊查询参数 */
        @Schema(description = "模糊查询参数") List<LikeDTO> likeQuery,
        /** 包含查询参数 */
        @Schema(description = "包含查询参数") List<InDTO> inQuery,
        /** 不包含查询参数 */
        @Schema(description = "不包含查询参数") List<NotInDTO> notInQuery)
    ...
    public static record NotInDTO(
            /** 字段名称 */
            @Schema(description = "字段名称") String filed,

            /** 字段值 */
            @Schema(description = "字段值") Object[] values) {}
    ...
    public static record EqDTO(
            ...
            /** 字段值 */
            @Schema(description = "字段值") Object value) {}
    ...
    public static record LikeDTO(
            ...
            /** 字段值 */
            @Schema(description = "字段值") String value) {}

    @Schema(name = "ExeclDTO", description = "ExeclDTO")
    public static record ExeclDTO(
            /** 下载文件名称 */
            @Schema(description = "下载文件名称") String fileName,
            /** 标题 */
            @Schema(description = "标题") String title,
            /** 排序 */
            @Schema(
                    description = "类型,默认HSSF",
                    allowableValues = "HSSF,XSSF",
                    example = "createTime")
            String type,
            /** sheetName */
            @Schema(description = "sheetName") String sheetName) {}
    ...
    public static record DateTimeBetweenDTO(
            ...
            /** 开始时间 */
            @Schema(description = "开始时间 时间格式:yyyy-MM-dd HH:mm:ss") LocalDateTime startTime,

            /** 结束时间 */
            @Schema(description = "结束时间 时间格式:yyyy-MM-dd HH:mm:ss") LocalDateTime endTime) {}
}
