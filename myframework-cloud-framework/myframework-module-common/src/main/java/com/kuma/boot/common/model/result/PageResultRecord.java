...
public record PageResultRecord<R>(
        /** 总条数 */
        @Schema(description = "总条数") long totalSize,
        /** 总页数 */
        @Schema(description = "总页数") int totalPage,
        /** 当前第几页 */
        @Schema(description = "当前第几页") int currentPage,
        /** 每页显示条数 */
        @Schema(description = "每页显示条数") int pageSize,
        /** 返回数据 */
        @Schema(description = "返回数据") List<R> data)
        implements Serializable {

    @Serial private static final long serialVersionUID = -275582248840137389L;
    ...
    // }
    //
    // public static <R, T> PageResult<R> convertMybatisPage(IPage<T> page, Class<R>
    // rClass) {
    ...
    // */
    // public static <R, T> PageResult<R> convertMybatisPage(
    // IPage<T> page, Class<R> rClass, Map<String, String> configMap) {
     ...
     */
    public static <R> PageResultRecord<R> of(
            long totalSize, int totalPage, int currentPage, int pageSize, List<R> data) {
        return new PageResultRecord<>(totalSize, totalPage, currentPage, pageSize, data);
    }
}
