...
public class ClassLoaderUtils {
    ...
    private static final ClassLoaderWeakCache<Constructor<?>> CONSTRUCTOR_CACHE =
            new ClassLoaderWeakCache<>();

    private static final ClassLoaderWeakCache<Class<?>> CLASS_CACHE = new ClassLoaderWeakCache<>();

    private static final boolean CLASS_CACHE_DISABLED =
            Boolean.getBoolean("classloading.cache.disabled");
    ...
    public static <T> T newInstance( final ClassLoader classLoaderHint, final String className )
            throws Exception {
    ...
    private static <T> T newInstance0( ClassLoader classLoader, String className ) throws Exception {
        Class<?> klass =
                classLoader == null
                        ...
                        : tryLoadClass(className, classLoader);
    ...
    public static Class<?> loadClass( final ClassLoader classLoaderHint, final String className )
    ...
    private static Class<?> tryPrimitiveClass( String className ) {
        if (className.length() <= MAX_PRIM_CLASS_NAME_LENGTH
    ...
    private static final class ClassLoaderWeakCache<V> {
        ...
        private void put( ClassLoader classLoader, String className, V value ) {
            ClassLoader cl =
                    classLoader == null ? ClassLoaderUtils.class.getClassLoader() : classLoader;
