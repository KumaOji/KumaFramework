 ...
 * <a href="http://commons.apache.org/proper/commons-lang/">Apache's Commons Lang</a> for
 * a more comprehensive suite of {@code String} utilities.
 *
 * <p>
 * This class delivers some simple functionality that should really be provided by the
 * core Java {@link String} and {@link StringBuilder} classes. It also provides
 * easy-to-use methods to convert between delimited strings, such as CSV strings, and
...
public abstract class StringUtils {
     ...
     * @return the {@code String} array ({@code null} if the supplied {@code Collection}
     * was {@code
     *     null})
     */
