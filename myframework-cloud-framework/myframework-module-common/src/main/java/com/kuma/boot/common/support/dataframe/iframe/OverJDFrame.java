...
public interface OverJDFrame<T> {
     ...
     * @param field field value
     */
    <F extends Comparable<? super F>> JDFrame<FI2<T, F>> overMaxValue(
     ...
     * @param field field value
     */
    <F extends Comparable<? super F>> JDFrame<T> overMaxValueS(
            SetFunction<T, F> setFunction, Window<T> overParam, Function<T, F> field);
     ...
     * @param field field value
     */
    <F extends Comparable<? super F>> JDFrame<FI2<T, F>> overMinValue(
            Window<T> overParam, Function<T, F> field);
     ...
     * @param field field value
     */
    <F extends Comparable<? super F>> JDFrame<T> overMinValueS(
            SetFunction<T, F> setFunction, Window<T> overParam, Function<T, F> field);
