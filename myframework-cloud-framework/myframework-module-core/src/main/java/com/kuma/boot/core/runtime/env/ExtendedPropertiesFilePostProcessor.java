...
public class ExtendedPropertiesFilePostProcessor implements EnvironmentPostProcessor, Ordered {
    /** 扩展属性配置文件 Key */
    public static final String EXTENDED_PROPERTIES_FILE_KEY          = "kuma.boot.core.extended.properties.file";
    /** 默认扩展属性配置文件 */
    public static final String DEFAULT_EXTENDED_PROPERTIES_FILE_PATH = "config/extended-config.properties";
