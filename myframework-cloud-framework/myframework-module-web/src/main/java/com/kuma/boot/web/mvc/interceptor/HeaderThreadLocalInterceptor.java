...
public class HeaderThreadLocalInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(
        ...
        //    MDC.put(ContextConstants.LOG_TRACE_ID, StrUtil.isEmpty(traceId) ? StrUtil.EMPTY :
        // traceId);
        //    MDC.put(ContextConstants.JWT_KEY_TENANT, getHeader(request,
        // ContextConstants.JWT_KEY_TENANT));
        //    MDC.put(ContextConstants.JWT_KEY_USER_ID, getHeader(request,
