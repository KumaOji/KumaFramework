...
public class ReflectionUtils {
    ...
    public static Object getFieldValue(Field field, Object obj) {
        try {
            ...
            LogUtils.debug("Failed to get field value: {}.{}", obj.getClass().getSimpleName(), field.getName(), e);
            return null;
        }
    }
    ...
    public static boolean setFieldValue(Field field, Object obj, Object value) {
        try {
            ...
            LogUtils.debug("Failed to set field value: {}.{}", obj.getClass().getSimpleName(), field.getName(), e);
            return false;
        }
    }
