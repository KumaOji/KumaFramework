...
/**
 * Implements the invocation of an {@link RequestMapping @RequestMapping}-annotated,
...
final class ShadedHttpServiceMethod {
     ...
     * and method-level {@link RequestMapping @HttpRequest} annotations.
     */
    private record HttpRequestValuesInitializer(
        ...
        public static HttpRequestValuesInitializer create(
            ...
            List<AnnotationDescriptor> methodHttpExchanges =
            ...
            List<AnnotationDescriptor> typeHttpExchanges =
        ...
        private static List<AnnotationDescriptor> getAnnotationDescriptors(
        ...
        private static class AnnotationDescriptor {
            ...
            public boolean equals(Object obj) {
                return (obj instanceof AnnotationDescriptor that
