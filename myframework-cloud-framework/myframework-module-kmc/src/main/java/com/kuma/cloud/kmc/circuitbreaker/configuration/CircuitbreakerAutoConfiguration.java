...
public class CircuitbreakerAutoConfiguration implements InitializingBean {

    @Override
    public void afterPropertiesSet() throws Exception {
        LogUtils.started(CircuitbreakerAutoConfiguration.class, StarterNameConstants.KMC_CLOUD_STARTER);
    }
