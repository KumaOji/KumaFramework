...
public class DynamicRoutingDataSource extends AbstractRoutingDataSource {
    ...
    protected Object determineCurrentLookupKey() {
        if (dbRwSeparateSwitch
                && DataSourceTypeEnum.SLAVE.equals(DataSourceContextHolder.getDataSourceType())) {
            LogUtils.info("DynamicRoutingDataSource 切换数据源到从库");
            return DataSourceTypeEnum.SLAVE;
        }
        LogUtils.info("DynamicRoutingDataSource 切换数据源到主库");
