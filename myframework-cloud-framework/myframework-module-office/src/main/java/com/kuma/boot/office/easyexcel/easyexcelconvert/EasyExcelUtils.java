 ...
 * @author kuma
 * @version
 *     2022.06 @ExcelIgnore：忽略掉该字段； @ExcelProperty("用户名")：设置该列的名称为”用户名“； @ColumnWidth(20)：设置表格列的宽度为20； @DateTimeFormat("yyyy-MM-dd")：按照指定的格式对日期进行格式化； @ExcelProperty(value
 *     = "性别", converter = GenderConverter.class)：自定义内容转换器，类似枚举的实现，将“男”、“女”转换成“0”、“1”的数值。
...
public class EasyExcelUtils {
    ...
    public static String convertByExp(String propertyValue, String converterExp, String separator) {
        ...
        return stripEnd(propertyString.toString(), separator);
    }
