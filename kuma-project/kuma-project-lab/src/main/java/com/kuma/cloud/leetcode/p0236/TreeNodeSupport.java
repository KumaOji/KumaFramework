...
public final class TreeNodeSupport {
    ...
    public static Solution.TreeNode findNode(Solution.TreeNode root, int value) {
        if (root == null) {
            return null;
        }
        if (root.val == value) {
        ...
        Solution.TreeNode left = findNode(root.left, value);
        if (left != null) {
            return left;
        }
    ...
    public static Integer valueOf(Solution.TreeNode node) {
