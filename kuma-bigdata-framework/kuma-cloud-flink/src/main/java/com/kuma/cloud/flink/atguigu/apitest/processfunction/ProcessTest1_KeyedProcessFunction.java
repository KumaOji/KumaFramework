...
package com.kuma.cloud.flink.atguigu.apitest.processfunction;

import com.kuma.cloud.flink.atguigu.apitest.beans.SensorReading;
...
public class ProcessTest1_KeyedProcessFunction {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        dataStream.keyBy(SensorReading::getId).process(new MyProcess()).print();
