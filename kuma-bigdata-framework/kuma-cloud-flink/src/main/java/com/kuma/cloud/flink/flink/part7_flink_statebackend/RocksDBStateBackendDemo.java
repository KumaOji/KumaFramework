...
package com.kuma.cloud.flink.flink.part7_flink_statebackend;
...
public class RocksDBStateBackendDemo {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        // JobManagerCheckpointStorage("file:///D:/flink-state"));
        env.getCheckpointConfig()
                .setCheckpointStorage(new FileSystemCheckpointStorage("file:///D:/flink-state"));
