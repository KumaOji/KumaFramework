...
package com.kuma.cloud.flink.flink.part5_flink_watermark;
...
public class SideOutputDemo {
    ...
    public static void main( String[] args ) throws Exception {
                            ...
                            public void run( SourceContext<String> ctx ) throws Exception {
                                while (running) {
                                    ...
                                    if (++count % 200 == 0) {
                                        ...
                                        // System.out.println("Manual Watermark emitted: " +
                                        // timestamp);
                                    }
                                    ...
                                    // System.out.println("Generated data: " + "key" + randomNum +
                                    // "," + 1 + "," + timestamp + " at " +
        ...
        // 窗口逻辑
        SingleOutputStreamOperator<Tuple2<String, Integer>> keyedStream =
                withWatermarks
                        ...
                        .process(
                                new ProcessWindowFunction<
                                    ...
                                    public void process(
                                        ...
                                        // System.out.println("Tumbling Window [start " +
                                        // formattedStart + ", end " + formattedEnd + ") for key " +
                                        // s);
                                        ...
                                        // System.out.println("Watermark at the end of window: " +
