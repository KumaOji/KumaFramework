...
package com.kuma.cloud.flink.ttc.window;

import com.kuma.cloud.flink.ttc.bean.WaterSensor;
import com.kuma.cloud.flink.ttc.functions.WaterSensorMapFunction;
...
public class WindowApiDemo {
    public static void main(String[] args) throws Exception {
        ...
        // 滚动窗口，窗口长度10s
        //        sensorKS.window(SlidingProcessingTimeWindows.of(Duration.ofSeconds(10),
        // Duration.ofSeconds(2))) // 滑动窗口，窗口长度10s，滑动步长2s
        //        sensorKS.window(ProcessingTimeSessionWindows.withGap(Duration.ofSeconds(5))) //
        // 会话窗口，超时间隔5s
