...
insert into log_meta (id, meta_type, field, field_type, field_desc, meta_version, status, create_time, update_time) values (5, 0, 'project', 'string', '项目-kuma-cloud-mimin-app 等等', 1.0, 0, '2020-11-04 06:50:56', null);
