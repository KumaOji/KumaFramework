...
package com.kuma.cloud.hudi.multiversion.commits;

import com.kuma.cloud.hudi.common.CustomDataGenerator;
import com.kuma.cloud.hudi.common.OpType;
import com.kuma.cloud.hudi.multiversion.MultiVersionDemo;
...
public class MergeOnReadCommitStrategyDemo extends CommitStrategyMultiVersion {
    ...
    public static void main(String[] args) {
        ...
        // NOTE that when "hoodie.compact.inline.max.delta.commits" is less than
        // hoodie.keep.max.commits,
        // there will be no compaction since the delta active instant is less than
