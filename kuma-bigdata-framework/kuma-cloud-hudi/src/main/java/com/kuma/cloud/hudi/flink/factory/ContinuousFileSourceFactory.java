...
package com.kuma.cloud.hudi.flink.factory;
...
public class ContinuousFileSourceFactory implements DynamicTableSourceFactory {
    ...
    public static final ConfigOption<Integer> CHECKPOINTS =
            ConfigOptions.key("checkpoints")
                    .intType()
                    .defaultValue(2)
                                ...
                                .orElseThrow(
                                        () ->
                                                new ValidationException(
                                                        "Option [path] should be not empty.")));
