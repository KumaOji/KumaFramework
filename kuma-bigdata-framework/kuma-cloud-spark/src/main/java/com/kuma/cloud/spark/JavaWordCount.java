 ...
 * 3.上传jar包提交集群运行
 * <p>
 * ./spark-submit \ --master spark://127.0.0.1:7077 \ --class com.kuma.cloud.spark.JavaWordCount \
 * --executor-memory 512m \ --total-executor-cores 2 \ /root/spark/jar/kuma-cloud-spark-1.0-all.jar
