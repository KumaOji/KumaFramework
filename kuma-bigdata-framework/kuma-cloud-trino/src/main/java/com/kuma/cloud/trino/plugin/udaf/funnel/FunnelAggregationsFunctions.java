...
package com.kuma.cloud.trino.plugin.udaf.funnel;
 ...
 * 计算漏斗深度(用户深度)
 * <p>
 * kuma_cloud_funnel(ctime, 86400*1000*3, event, 'SingUp,AppPageView,AppClick,NewsAction')
 *
 * @author kuma
 * @version 2022.04
 * @since 2021/1/25 下午3:52
 */
@AggregationFunction("kuma_cloud_funnel")
